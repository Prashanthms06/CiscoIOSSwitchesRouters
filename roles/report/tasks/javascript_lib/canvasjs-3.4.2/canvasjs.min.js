/*
 CanvasJS HTML5 & JavaScript Charts - v3.4.2 GA - https://canvasjs.com/ 
...
/*eslint-disable*/
/*jshint ignore:start*/
(function(){function oa(h,m){h.prototype=cb(m.prototype);h.prototype.constructor=h;h.base=m.prototype}function cb(h){function m(){}m.prototype=h;return new m}function Va(h,m,w){"millisecond"===w?h.setMilliseconds(h.getMilliseconds()+1*m):"second"===w?h.setSeconds(h.getSeconds()+1*m):"minute"===w?h.setMinutes(h.getMinutes()+1*m):"hour"===w?h.setHours(h.getHours()+1*m):"day"===w?h.setDate(h.getDate()+1*m):"week"===w?h.setDate(h.getDate()+7*m):"month"===w?h.setMonth(h.getMonth()+1*m):"year"===w&&h.setFullYear(h.getFullYear()+
1*m);return h}function X(h,m){var w=!1;0>h&&(w=!0,h*=-1);h=""+h;for(m=m?m:1;h.length<m;)h="0"+h;return w?"-"+h:h}function Fa(h){if(!h)return h;h=h.replace(/^\s\s*/,"");for(var m=/\s/,w=h.length;m.test(h.charAt(--w)););return h.slice(0,w+1)}function Ba(h){h.roundRect=function(h,w,s,u,ra,D,y,F){y&&(this.fillStyle=y);F&&(this.strokeStyle=F);"undefined"===typeof ra&&(ra=5);this.lineWidth=D;this.beginPath();this.moveTo(h+ra,w);this.lineTo(h+s-ra,w);this.quadraticCurveTo(h+s,w,h+s,w+ra);this.lineTo(h+s,
w+u-ra);this.quadraticCurveTo(h+s,w+u,h+s-ra,w+u);this.lineTo(h+ra,w+u);this.quadraticCurveTo(h,w+u,h,w+u-ra);this.lineTo(h,w+ra);this.quadraticCurveTo(h,w,h+ra,w);this.closePath();y&&this.fill();F&&0<D&&this.stroke()}}function Pa(h,m){return h-m}function P(h){var m=((h&16711680)>>16).toString(16),w=((h&65280)>>8).toString(16);h=((h&255)>>0).toString(16);m=2>m.length?"0"+m:m;w=2>w.length?"0"+w:w;h=2>h.length?"0"+h:h;return"#"+m+w+h}function db(h,m){var w=this.length>>>0,s=Number(m)||0,s=0>s?Math.ceil(s):
Math.floor(s);for(0>s&&(s+=w);s<w;s++)if(s in this&&this[s]===h)return s;return-1}function s(h){return null===h||"undefined"===typeof h}function Ca(h){h.indexOf||(h.indexOf=db);return h}function eb(h){if(S.fSDec)h[W("`eeDwdouMhrudods")](W("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){S._fTWm&&S._fTWm(h)})}function Wa(h,m,w){w=w||"normal";var s=h+"_"+m+"_"+w,u=Xa[s];if(isNaN(u)){try{h="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+
h+"; font-size:"+m+"px; font-weight:"+w+";";if(!wa){var ra=document.body;wa=document.createElement("span");wa.innerHTML="";var D=document.createTextNode("Mpgyi");wa.appendChild(D);ra.appendChild(wa)}wa.style.display="";wa.setAttribute("style",h);u=Math.round(wa.offsetHeight);wa.style.display="none"}catch(y){u=Math.ceil(1.1*m)}u=Math.max(u,m);Xa[s]=u}return u}function N(h,m){var w=[];if(w={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,
2],dashDot:[4,2,1,2],longDash:[8,2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[h||"solid"])for(var s=0;s<w.length;s++)w[s]*=m;else w=[];return w}function J(h,m,w,u,qa){u=u||[];qa=s(qa)?fb?{passive:!1,capture:!1}:!1:qa;u.push([h,m,w,qa]);return h.addEventListener?(h.addEventListener(m,w,qa),w):h.attachEvent?(u=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};w.call(h,m)},h.attachEvent("on"+
m,u),u):!1}function gb(h){if(h._menuButton)h.exportEnabled?(ga(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),Ka(h._menuButton),h._menuButton.title=h._cultureInfo.menuText):ua(h._menuButton);else if(h.exportEnabled&&u){var m=!1;h._menuButton=document.createElement("button");va(h,h._menuButton,"menu");h._toolBar.appendChild(h._menuButton);J(h._menuButton,"touchstart",function(h){m=!0},h.allDOMEventHandlers);J(h._menuButton,"click",function(){"none"!==h._dropdownMenu.style.display||
h._dropDownCloseTime&&500>=(new Date).getTime()-h._dropDownCloseTime.getTime()||(h._dropdownMenu.style.display="block",h._menuButton.blur(),h._dropdownMenu.focus())},h.allDOMEventHandlers,!0);J(h._menuButton,"mouseover",function(){m||(ga(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColorOnHover,color:h.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&ga(h._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},h.allDOMEventHandlers,!0);J(h._menuButton,
"mouseout",function(){m||(ga(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),0>=navigator.userAgent.search("MSIE")&&ga(h._menuButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},h.allDOMEventHandlers,!0)}if(h.exportEnabled&&h._dropdownMenu){ga(h._dropdownMenu,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor});for(var w=h._dropdownMenu.childNodes,s=[h._cultureInfo.printText,h._cultureInfo.saveJPGText,h._cultureInfo.savePNGText],
qa=0;qa<w.length;qa++)ga(w[qa],{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),w[qa].innerHTML=s[qa]}else!h._dropdownMenu&&(h.exportEnabled&&u)&&(m=!1,h._dropdownMenu=document.createElement("div"),h._dropdownMenu.setAttribute("tabindex",-1),w=-1!==h.theme.indexOf("dark")?"black":"#888888",h._dropdownMenu.style.cssText="position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:"+
h.toolbar.itemBackgroundColor+";box-shadow: 2px 2px 10px "+w,h._dropdownMenu.style.display="none",h._toolBar.appendChild(h._dropdownMenu),J(h._dropdownMenu,"blur",function(){ua(h._dropdownMenu);h._dropDownCloseTime=new Date},h.allDOMEventHandlers,!0),w=document.createElement("div"),w.style.cssText="padding: 12px 8px 12px 8px",w.innerHTML=h._cultureInfo.printText,w.style.backgroundColor=h.toolbar.itemBackgroundColor,w.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(w),J(w,"touchstart",
function(h){m=!0},h.allDOMEventHandlers),J(w,"mouseover",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),J(w,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),J(w,"click",function(){h.print();ua(h._dropdownMenu)},h.allDOMEventHandlers,!0),w=document.createElement("div"),w.style.cssText="padding: 12px 8px 12px 8px",
w.innerHTML=h._cultureInfo.saveJPGText,w.style.backgroundColor=h.toolbar.itemBackgroundColor,w.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(w),J(w,"touchstart",function(h){m=!0},h.allDOMEventHandlers),J(w,"mouseover",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),J(w,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},
h.allDOMEventHandlers,!0),J(w,"click",function(){h.exportChart({format:"jpeg",fileName:h.exportFileName});ua(h._dropdownMenu)},h.allDOMEventHandlers,!0),w=document.createElement("div"),w.style.cssText="padding: 12px 8px 12px 8px",w.innerHTML=h._cultureInfo.savePNGText,w.style.backgroundColor=h.toolbar.itemBackgroundColor,w.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(w),J(w,"touchstart",function(h){m=!0},h.allDOMEventHandlers),J(w,"mouseover",function(){m||(this.style.backgroundColor=
h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),J(w,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),J(w,"click",function(){h.exportChart({format:"png",fileName:h.exportFileName});ua(h._dropdownMenu)},h.allDOMEventHandlers,!0))}function Ya(h,m,w){h*=ka;m*=ka;h=w.getImageData(h,m,2,2).data;m=!0;for(w=0;4>w;w++)if(h[w]!==h[w+4]|h[w]!==h[w+8]|
h[w]!==h[w+12]){m=!1;break}return m?h[0]<<16|h[1]<<8|h[2]:0}function la(h,m,w){return h in m?m[h]:w[h]}function La(h,m,w){if(u&&Za){var s=h.getContext("2d");Ma=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;ka=Qa/Ma;h.width=m*ka;h.height=w*ka;Qa!==Ma&&(h.style.width=m+"px",h.style.height=w+"px",s.scale(ka,ka))}else h.width=m,h.height=w}function hb(h){if(!ib){var m=!1,w=!1;"undefined"===typeof pa.Chart.creditHref?
(h.creditHref=W("iuuqr;..b`ow`rkr/bnl."),h.creditText=W("B`ow`rKR/bnl")):(m=h.updateOption("creditText"),w=h.updateOption("creditHref"));if(h.creditHref&&h.creditText){h._creditLink||(h._creditLink=document.createElement("a"),h._creditLink.setAttribute("class","canvasjs-chart-credit"),h._creditLink.setAttribute("title","JavaScript Charts"),h._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;right:2px;top:"+(h.height-14)+"px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),
...
var w=document.createElement("canvas");w.setAttribute("class","canvasjs-chart-canvas");La(w,h,m);u||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(w);return w}function ga(h,m){for(var w in m)h.style[w]=m[w]}function va(h,m,w){m.getAttribute("state")||(m.style.backgroundColor=h.toolbar.itemBackgroundColor,m.style.color=h.toolbar.fontColor,m.style.border="none",ga(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
w&&(m.setAttribute("state",w),m.setAttribute("type","button"),ga(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.setAttribute("title",h._cultureInfo[w+"Text"]),m.innerHTML="<img style='height:95%; pointer-events: none;' src='"+jb[w].image+"' alt='"+h._cultureInfo[w+"Text"]+"' />")}function Ka(){for(var h=null,m=0;m<arguments.length;m++)h=arguments[m],h.style&&(h.style.display="inline")}function ua(){for(var h=
null,m=0;m<arguments.length;m++)(h=arguments[m])&&h.style&&(h.style.display="none")}function Ra(h,m,w,s,u){if(null===h||"undefined"===typeof h)return"undefined"===typeof w?m:w;h=parseFloat(h.toString())*(0<=h.toString().indexOf("%")?m/100:1);"undefined"!==typeof s&&(h=Math.min(s,h),"undefined"!==typeof u&&(h=Math.max(u,h)));return!isNaN(h)&&h<=m&&0<=h?h:"undefined"===typeof w?m:w}function U(h,m,w,u,qa){this._defaultsKey=h;this._themeOptionsKey=m;this._index=u;this.parent=qa;this._eventListeners=[];
...
[]}function Ia(h){var m;h&&Ja[h]&&(m=Ja[h]);Ia.base.constructor.call(this,"CultureInfo",null,m,null,null)}var Ga=!1,S={},u=!!document.createElement("canvas").getContext,pa={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditHref:"",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",
...
thickness:2,lineDashType:"solid",label:"",labelPlacement:"inside",labelAlign:"far",labelWrap:!0,labelMaxWidth:null,labelBackgroundColor:null,labelBorderColor:u?"transparent":null,labelBorderThickness:0,labelCornerRadius:0,labelFontFamily:"arial",labelFontColor:"orange",labelFontSize:12,labelFontWeight:"normal",labelFontStyle:"normal",labelFormatter:null,showOnTop:!1,publicProperties:{options:"readWrite",axis:"readOnly",bounds:"readOnly",chart:"readOnly"}},ScaleBreaks:{autoCalculate:!1,collapsibleThreshold:"25%",
...
Ja={en:{}},y=u?"Trebuchet MS, Helvetica, sans-serif":"Arial",Ea=u?"Impact, Charcoal, sans-serif":"Arial",za={colorSet1:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "),colorSet2:"#6D78AD #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "),colorSet3:"#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")},
...
hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};(function(){S.fSDec=function(h){for(var m="",w=0;w<h.length;w++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(w));return m};delete pa[S.fSDec("Bi`su")][S.fSDec("bsdehuIsdg")];S.pro={sCH:pa[S.fSDec("Bi`su")][S.fSDec("bsdehuIsdg")]};S.pos=["cm","cs","um"];S._fTWm=function(h){if("undefined"===typeof S.pro.sCH&&!bb)try{var m=
(new Date).getMonth()%3,w,s,u=h[S.fSDec("buy")];u[S.fSDec("udyuC`rdmhod")]=S.fSDec("unq");u[S.fSDec("gnou")]=11+S.fSDec("qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg");u[S.fSDec("ghmmRuxmd")]=S.fSDec("fsdx");w="cm"===S.pos[m]||"um"===S.pos[m]?0:h.width-u[S.fSDec("ld`rtsdUdyu")](S.fSDec("B`ow`rKR!Ush`m")).width;s="um"===S.pos[m]?0:h.height-11;u[S.fSDec("ghmmUdyu")](S.fSDec("B`ow`rKR!Ush`m"),w,s);"cs"===S.pos[m]&&(h[S.fSDec("^bsdehuMhoj")].style.right=S.fSDec("`tun"))}catch(y){}}})();
var fb=function(){var h=!1;try{var m=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){h=!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,m),window.removeEventListener("test",null,m))}catch(w){h=!1}return h}(),Xa={},wa=null,kb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},lb=function(h,m,w){m=Math.min(this.width,this.height);
...
D=/[^-+\dA-Z]/g;return function(F,N,M){var H=M?M.days:m,P=M?M.months:s,J=M?M.shortDays:w,R=M?M.shortMonths:u;M="";var S=!1;F=F&&F.getTime?F:F?new Date(F):new Date;if(isNaN(F))throw SyntaxError("invalid date");"UTC:"===N.slice(0,4)&&(N=N.slice(4),S=!0);M=S?"getUTC":"get";var U=F[M+"Date"](),K=F[M+"Day"](),V=F[M+"Month"](),a=F[M+"FullYear"](),d=F[M+"Hours"](),c=F[M+"Minutes"](),b=F[M+"Seconds"](),e=F[M+"Milliseconds"](),f=S?0:F.getTimezoneOffset();return M=N.replace(h,function(l){switch(l){case "D":return U;
...
case "f":return X(String(e),3).slice(0,1);case "ff":return X(String(e),3).slice(0,2);case "fff":return X(String(e),3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return S?"UTC":(String(F).match(y)||[""]).pop().replace(D,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+X(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+X(Math.floor(Math.abs(f)/60),2)+
X(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),ea=function(h,m,w){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var s=0>h?!0:!1;s&&(h*=-1);var u=w?w.decimalSeparator:".",y=w?w.digitGroupSeparator:",",D="";m=String(m);var D=1,F=w="",N=-1,M=[],H=[],P=0,J=0,R=0,S=!1,U=0,F=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var K=0;F&&K<F.length;K++)if(m=F[K],"."===m&&0>N)N=K;else{if("%"===m)D*=100;else if("\u2030"===m){D*=1E3;continue}else if(","===m[0]&&
"."===m[m.length-1]){D/=Math.pow(1E3,m.length-1);N=K+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(S=!0);0>N?(M.push(m),"#"===m||"0"===m?P++:","===m&&R++):(H.push(m),"#"!==m&&"0"!==m||J++)}S&&(m=Math.floor(h),F=-Math.floor(Math.log(h)/Math.LN10+1),U=0===h?0:0===m?-(P+F):String(m).length-P,D/=Math.pow(10,U));0>N&&(N=K);D=(h*D).toFixed(J);m=D.split(".");D=(m[0]+"").split("");h=(m[1]+"").split("");D&&"0"===D[0]&&D.shift();for(S=F=K=J=N=0;0<M.length;)if(m=M.pop(),"#"===m||"0"===
m)if(N++,N===P){var V=D,D=[];if("0"===m)for(m=P-J-(V?V.length:0);0<m;)V.unshift("0"),m--;for(;0<V.length;)w=V.pop()+w,S++,0===S%F&&(K===R&&0<V.length)&&(w=y+w)}else 0<D.length?(w=D.pop()+w,J++,S++):"0"===m&&(w="0"+w,J++,S++),0===S%F&&(K===R&&0<D.length)&&(w=y+w);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(K++,F=S,S=0,0<D.length&&(w=y+w)):w=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+w:m+w:(m=0>U?m.replace("+",
"").replace("-",""):m.replace("-",""),w+=m.replace(/[0]+/,function(a){return X(U,a.length)}));y="";for(M=!1;0<H.length;)m=H.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?(y+=h.shift(),M=!0):"0"===m&&(y+="0",M=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?y+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?y+=m:(m=0>U?m.replace("+","").replace("-",""):m.replace("-",""),y+=m.replace(/[0]+/,function(a){return X(U,
a.length)}));w+=(M?u:"")+y;return s?"-"+w:w},Na=function(h){var m=0,w=0;h=h||window.event;h.offsetX||0===h.offsetX?(m=h.offsetX,w=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,w=h.layerY):(m=h.pageX-h.target.offsetLeft,w=h.pageY-h.target.offsetTop);return{x:m,y:w}},Za=!0,Qa=window.devicePixelRatio||1,Ma=1,ka=Za?Qa/Ma:1,ca=function(h,m,w,s,u,y,D,F,N,M,P,S,H){"undefined"===typeof H&&(H=1);D=D||0;F=F||"black";var J=15<s-m&&15<u-w?8:0.35*Math.min(s-m,u-w);h.beginPath();h.moveTo(m,w);h.save();h.fillStyle=
y;h.globalAlpha=H;h.fillRect(m,w,s-m,u-w);h.globalAlpha=1;0<D&&(H=0===D%2?0:0.5,h.beginPath(),h.lineWidth=D,h.strokeStyle=F,h.moveTo(m,w),h.rect(m-H,w-H,s-m+2*H,u-w+2*H),h.stroke());h.restore();!0===N&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+J,w+J),h.lineTo(s-J,w+J),h.lineTo(s,w),h.closePath(),D=h.createLinearGradient((s+m)/2,w+J,(s+m)/2,w),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=D,h.fill(),h.restore());!0===M&&(h.save(),h.beginPath(),h.moveTo(m,u),h.lineTo(m+
J,u-J),h.lineTo(s-J,u-J),h.lineTo(s,u),h.closePath(),D=h.createLinearGradient((s+m)/2,u-J,(s+m)/2,u),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=D,h.fill(),h.restore());!0===P&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+J,w+J),h.lineTo(m+J,u-J),h.lineTo(m,u),h.closePath(),D=h.createLinearGradient(m+J,(u+w)/2,m,(u+w)/2),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=D,h.fill(),h.restore());!0===S&&(h.save(),h.beginPath(),h.moveTo(s,
w),h.lineTo(s-J,w+J),h.lineTo(s-J,u-J),h.lineTo(s,u),D=h.createLinearGradient(s-J,(u+w)/2,s,(u+w)/2),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=D,D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=D,h.fill(),h.closePath(),h.restore())},W=function(h){for(var m="",s=0;s<h.length;s++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(s));return m},bb=window&&window[W("mnb`uhno")]&&window[W("mnb`uhno")].href&&window[W("mnb`uhno")].href.indexOf&&
...
U.prototype.setOptions=function(h,m){if(pa[this._defaultsKey]){var s=pa[this._defaultsKey],u;for(u in s)"publicProperties"!==u&&s.hasOwnProperty(u)&&(this[u]=h&&u in h?h[u]:m&&u in m?m[u]:s[u])}else Ga&&window.console&&console.log("defaults not set")};U.prototype.get=function(h){var m=pa[this._defaultsKey];if("options"===h)return this.options&&this.options._isPlaceholder?null:this.options;if(m.hasOwnProperty(h)||m.publicProperties&&m.publicProperties.hasOwnProperty(h))return this[h];window.console&&
window.console.log('Property "'+h+"\" doesn't exist. Please check for typo.")};U.prototype.set=function(h,m,s){s="undefined"===typeof s?!0:s;var u=pa[this._defaultsKey];if("options"===h)this.createUserOptions(m);else if(u.hasOwnProperty(h)||u.publicProperties&&u.publicProperties.hasOwnProperty(h)&&"readWrite"===u.publicProperties[h])this.options._isPlaceholder&&this.createUserOptions(),this.options[h]=m;else{window.console&&(u.publicProperties&&u.publicProperties.hasOwnProperty(h)&&"readOnly"===u.publicProperties[h]?
window.console.log('Property "'+h+'" is read-only.'):window.console.log('Property "'+h+"\" doesn't exist. Please check for typo."));return}s&&(this.stockChart||this.chart||this).render()};U.prototype.addTo=function(h,m,s,u){u="undefined"===typeof u?!0:u;var y=pa[this._defaultsKey];y.hasOwnProperty(h)||y.publicProperties&&y.publicProperties.hasOwnProperty(h)&&"readWrite"===y.publicProperties[h]?(this.options._isPlaceholder&&this.createUserOptions(),"undefined"===typeof this.options[h]&&(this.options[h]=
...
m=s):m=void 0,h[m]=this.options};U.prototype.remove=function(h){h="undefined"===typeof h?!0:h;if(this.isOptionsInArray){var m=this.parent.options[this.optionsName];Ca(m);var s=m.indexOf(this.options);0<=s&&m.splice(s,1)}else delete this.parent.options[this.optionsName];h&&(this.stockChart||this.chart||this).render()};U.prototype.updateOption=function(h){!pa[this._defaultsKey]&&(Ga&&window.console)&&console.log("defaults not set");var m=pa[this._defaultsKey],u={},y=this[h],F=this._themeOptionsKey,
J=this._index;this.theme&&s(this.parent)&&s(F)&&s(J)?u=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[F])&&(null===J?u=this.parent.themeOptions[F]:0<this.parent.themeOptions[F].length&&(u=Math.min(this.parent.themeOptions[F].length-1,J),u=this.parent.themeOptions[F][u]));this.themeOptions=u;h in m&&(y=h in this.options?this.options[h]:u&&h in u?u[h]:m[h]);if(y===this[h])return!1;this[h]=
...
this._wrappedText.lines[s];if("right"===this.horizontalAlign||"right"===this.textAlign)u=this.width-F.width-this.rightPadding;else if("left"===this.horizontalAlign||"left"===this.textAlign)u=this.leftPadding;else if("center"===this.horizontalAlign||"center"===this.textAlign)u=(this.width-(this.leftPadding+this.rightPadding))/2-F.width/2+this.leftPadding;this.ctx.fillText(F.text,u,y);y+=F.height}this.ctx.font=m;h&&this.ctx.restore()}};ia.prototype.setText=function(h){this.text=h;this._isDirty=!0;this._wrappedText=
null};ia.prototype.measureText=function(){this._lineHeight=Wa(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ia.prototype._getLineWithWidth=function(h,m,s){h=String(h);if(!h)return{text:"",width:0};var u=s=0,y=h.length-1,F=Infinity;for(this.ctx.font=this._getFontString();u<=y;){var F=Math.floor((u+y)/2),D=h.substr(0,F+1);s=this.ctx.measureText(D).width;
if(s<m)u=F+1;else if(s>m)y=F-1;else break}s>m&&1<D.length&&(D=D.substr(0,D.length-1),s=this.ctx.measureText(D).width);m=!0;if(D.length===h.length||" "===h[D.length])m=!1;m&&(h=D.split(" "),1<h.length&&h.pop(),D=h.join(" "),s=this.ctx.measureText(D).width);return{text:D,width:s}};ia.prototype._wrapText=function(){var h=new String(Fa(String(this.text))),m=[],s=this.ctx.font,u=0,y=0;this.ctx.font=this._getFontString();if(0===this.frontSize)y=u=0;else for(;0<h.length;){var F=this.maxHeight-(this.topPadding+
this.bottomPadding),D=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);D.height=this._lineHeight;m.push(D);var J=y,y=Math.max(y,D.width),u=u+D.height,h=Fa(h.slice(D.text.length,h.length));F&&u>F&&(D=m.pop(),u-=D.height,y=J)}this._wrappedText={lines:m,width:y,height:u};this.width=y+(this.leftPadding+this.rightPadding);this.height=u+(this.topPadding+this.bottomPadding);this.ctx.font=s};ia.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!u&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return h+=m};oa(Sa,U);oa(ya,U);ya.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=h.layoutManager.getFreeSpace(),u=m.x1,y=m.y1,F=0,J=0,D=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,N,H;"top"===this.verticalAlign||
...
u;J.y=y;J.angle=F;J.horizontalAlign=N;this._textBlock=J;h.layoutManager.registerSpace(H,{width:this.width+("left"===H||"right"===H?this.margin+2:0),height:this.height+("top"===H||"bottom"===H?this.margin+2:0)});this.bounds={x1:u,y1:y,x2:u+this.width,y2:y+this.height};this.ctx.textBaseline="top"}};ya.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};oa(Ha,U);Ha.prototype.setLayout=ya.prototype.setLayout;Ha.prototype.render=ya.prototype.render;Ta.prototype.get=function(h,m){var u=
null;0<this.pool.length?(u=this.pool.pop(),La(u,h,m)):u=ta(h,m);return u};Ta.prototype.release=function(h){this.pool.push(h)};oa(Ia,U);var Oa={addTheme:function(h,m){ab[h]=m},addColorSet:function(h,m){za[h]=m},addCultureInfo:function(h,m){Ja[h]=m},formatNumber:function(h,m,u){u=u||"en";if(Ja[u])return ea(h,m||"#,##0.##",new Ia(u));throw"Unknown Culture Name";},formatDate:function(h,m,u){u=u||"en";if(Ja[u])return Aa(h,m||"DD MMM YYYY",new Ia(u));throw"Unknown Culture Name";}};"undefined"!==typeof module&&
...
2+1;var A=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[v].x>a[f].x&&0<A||a[v].x<a[f].x&&0>A?{x:a[v].x+A/3,y:a[v].y+b/3}:{x:a[v].x,y:a[v].y+b/9};v=e;f=0===v?0:v-1;l=v===a.length-1?v:v+1;b=Math.abs((a[l].x-a[f].x)/(0===a[v].x-a[f].x?0.01:a[v].x-a[f].x))*(d-1)/2+1;A=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[v].x>a[f].x&&0<A||a[v].x<a[f].x&&0>A?{x:a[v].x-A/3,y:a[v].y-b/3}:{x:a[v].x,y:a[v].y-b/9};c[c.length]=a[e]}return c}function y(a,d,c,b,e,f,l,v,A,k){var n=0;k?(l.color=f,v.color=f):
k=1;n=A?Math.abs(e-c):Math.abs(b-d);n=0<l.trimLength?Math.abs(n*l.trimLength/100):Math.abs(n-l.length);A?(c+=n/2,e-=n/2):(d+=n/2,b-=n/2);var n=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(v.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=v.color||f;a.lineWidth=v.thickness||2;a.setLineDash&&a.setLineDash(N(v.dashType,v.thickness));a.beginPath();A&&0<v.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):0<v.thickness&&(a.moveTo(Math.round((d+
...
new Ia(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&u;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");this.toolbar=new Sa(this,this.options.toolbar);if(this.options.zoomEnabled||this.panEnabled){if(this._zoomButton)ga(this._zoomButton,{borderRight:this.toolbar.buttonBorderThickness+
...
this.legend.dockInsidePlotArea?a.push(this.legend):this.legend.setLayout();for(d=0;d<this._axes.length;d++)if(this._axes[d].scaleBreaks&&this._axes[d].scaleBreaks._appliedBreaks.length){u?(this._breaksCanvas=ta(this.width,this.height,!0),this._breaksCanvasCtx=this._breaksCanvas.getContext("2d")):(this._breaksCanvas=this.canvas,this._breaksCanvasCtx=this.ctx);break}this._preRenderCanvas=ta(this.width,this.height);this._preRenderCtx=this._preRenderCanvas.getContext("2d");"normal"!==this.plotInfo.axisPlacement&&
"xySwapped"!==this.plotInfo.axisPlacement||D.setLayout(this.axisX,this.axisX2,this.axisY,this.axisY2,this.plotInfo.axisPlacement,this.layoutManager.getFreeSpace())};m.prototype.renderElements=function(){var a=this._plotAreaElements;this.title&&!this.title.dockInsidePlotArea&&this.title.render();for(var d=0;d<this.subtitles.length;d++)this.subtitles[d].dockInsidePlotArea||this.subtitles[d].render();this.legend.dockInsidePlotArea||this.legend.render();if("normal"===this.plotInfo.axisPlacement||"xySwapped"===
this.plotInfo.axisPlacement)D.render(this.axisX,this.axisX2,this.axisY,this.axisY2,this.plotInfo.axisPlacement);else if("none"===this.plotInfo.axisPlacement)this.preparePlotArea();else return;for(d=0;d<a.length;d++)a[d].setLayout(),a[d].render();var c=[];if(this.animatedRender){var b=ta(this.width,this.height);b.getContext("2d").drawImage(this.canvas,0,0,this.width,this.height)}hb(this);var a=this.ctx.miterLimit,e;this.ctx.miterLimit=3;u&&this._breaksCanvas&&(this._preRenderCtx.drawImage(this.canvas,
0,0,this.width,this.height),this._preRenderCtx.drawImage(this._breaksCanvas,0,0,this.width,this.height),this._breaksCanvasCtx.globalCompositeOperation="source-atop",this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),this._preRenderCtx.clearRect(0,0,this.width,this.height));for(d=0;d<this.plotInfo.plotTypes.length;d++)for(var f=this.plotInfo.plotTypes[d],l=0;l<f.plotUnits.length;l++){var v=f.plotUnits[l],A=null;v.targetCanvas=null;this.animatedRender&&(v.targetCanvas=
ta(this.width,this.height),v.targetCanvasCtx=v.targetCanvas.getContext("2d"),e=v.targetCanvasCtx.miterLimit,v.targetCanvasCtx.miterLimit=3);"line"===v.type?A=this.renderLine(v):"stepLine"===v.type?A=this.renderStepLine(v):"spline"===v.type?A=this.renderSpline(v):"column"===v.type?A=this.renderColumn(v):"bar"===v.type?A=this.renderBar(v):"area"===v.type?A=this.renderArea(v):"stepArea"===v.type?A=this.renderStepArea(v):"splineArea"===v.type?A=this.renderSplineArea(v):"stackedColumn"===v.type?A=this.renderStackedColumn(v):
...
"candlestick"===v.type?A=this.renderCandlestick(v):"ohlc"===v.type?A=this.renderCandlestick(v):"rangeColumn"===v.type?A=this.renderRangeColumn(v):"error"===v.type?A=this.renderError(v):"rangeBar"===v.type?A=this.renderRangeBar(v):"rangeArea"===v.type?A=this.renderRangeArea(v):"rangeSplineArea"===v.type?A=this.renderRangeSplineArea(v):"waterfall"===v.type?A=this.renderWaterfall(v):"boxAndWhisker"===v.type&&(A=this.renderBoxAndWhisker(v));for(var k=0;k<v.dataSeriesIndexes.length;k++)this._dataInRenderedOrder.push(this.data[v.dataSeriesIndexes[k]]);
this.animatedRender&&(v.targetCanvasCtx.miterLimit=e,A&&c.push(A))}this.ctx.miterLimit=a;this.animatedRender&&this._breaksCanvasCtx&&c.push({source:this._breaksCanvasCtx,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0,startTimePercent:0.7});this.animatedRender&&0<this._indexLabels.length&&(e=ta(this.width,this.height).getContext("2d"),c.push(this.renderIndexLabels(e)));var n=this;if(0<c.length)n.disableToolTip=!0,n._animator.animate(200,
n.animationDuration,function(a){n.ctx.clearRect(0,0,n.width,n.height);n.ctx.drawImage(b,0,0,Math.floor(n.width*ka),Math.floor(n.height*ka),0,0,n.width,n.height);for(var e=0;e<c.length;e++)A=c[e],1>a&&"undefined"!==typeof A.startTimePercent?a>=A.startTimePercent&&A.animationCallback(A.easingFunction(a-A.startTimePercent,0,1,1-A.startTimePercent),A):A.animationCallback(A.easingFunction(a,0,1,1),A);n.dispatchEvent("dataAnimationIterationEnd",{chart:n})},function(){c=[];for(var a=0;a<n.plotInfo.plotTypes.length;a++)for(var e=
n.plotInfo.plotTypes[a],d=0;d<e.plotUnits.length;d++)e.plotUnits[d].targetCanvas=null;b=null;n.disableToolTip=!1;n.dispatchEvent("dataAnimationEnd",{chart:n})});else{if(n._breaksCanvas)if(u)n.plotArea.ctx.drawImage(n._breaksCanvas,0,0,this.width,this.height);else for(k=0;k<n._axes.length;k++)n._axes[k].createMask();0<n._indexLabels.length&&n.renderIndexLabels();n.dispatchEvent("dataAnimationIterationEnd",{chart:n});n.dispatchEvent("dataAnimationEnd",{chart:n})}this.attachPlotAreaEventHandlers();this.zoomEnabled||
(this.panEnabled||!this._zoomButton||"none"===this._zoomButton.style.display)||ua(this._zoomButton,this._resetButton);this.toolTip._updateToolTip();this.renderCount++;Ga&&(n=this,setTimeout(function(){var a=document.getElementById("ghostCanvasCopy");a&&(La(a,n.width,n.height),a.getContext("2d").drawImage(n._eventManager.ghostCanvas,0,0))},2E3));this._breaksCanvas&&(delete this._breaksCanvas,delete this._breaksCanvasCtx);for(k=0;k<this._axes.length;k++)this._axes[k].maskCanvas&&(delete this._axes[k].maskCanvas,
...
this.data[d],a.dataPoints&&(0!==a.dataPoints.length&&a.visible)&&0<=m._supportedChartTypes.indexOf(a.type)){for(var c=null,b=!1,e=null,f=!1,l=0;l<this.plotInfo.plotTypes.length;l++)if(this.plotInfo.plotTypes[l].type===a.type){b=!0;c=this.plotInfo.plotTypes[l];break}b||(c={type:a.type,totalDataSeries:0,plotUnits:[]},this.plotInfo.plotTypes.push(c));for(l=0;l<c.plotUnits.length;l++)if(c.plotUnits[l].axisYType===a.axisYType&&c.plotUnits[l].axisXType===a.axisXType&&c.plotUnits[l].axisYIndex===a.axisYIndex&&
...
"waterfall"===b.type&&this._processSpecificPlotUnit(b)}this.calculateAutoBreaks()};m.prototype._processMultiseriesPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=0;l<a.dataSeriesIndexes.length;l++){var v=this.data[a.dataSeriesIndexes[l]],A=0,k=!1,n=!1,p;if("normal"===v.axisPlacement||"xySwapped"===v.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&
this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,g=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(v.dataPoints[A].x&&v.dataPoints[A].x.getTime||"dateTime"===
v.xValueType)f=!0;for(A=0;A<v.dataPoints.length;A++){"undefined"===typeof v.dataPoints[A].x&&(v.dataPoints[A].x=A+(a.axisX.logarithmic?1:0));v.dataPoints[A].x.getTime?(f=!0,b=v.dataPoints[A].x.getTime()):b=v.dataPoints[A].x;e=v.dataPoints[A].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);e<d.min&&"number"===typeof e&&(d.min=e);e>d.max&&"number"===typeof e&&(d.max=e);if(0<A){if(a.axisX.logarithmic){var r=b/v.dataPoints[A-1].x;1>r&&(r=1/r);c.minDiff>r&&1!==r&&(c.minDiff=r)}else r=b-v.dataPoints[A-1].x,0>r&&
(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r);null!==e&&null!==v.dataPoints[A-1].y&&(a.axisY.logarithmic?(r=e/v.dataPoints[A-1].y,1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e-v.dataPoints[A-1].y,0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r)))}if(b<q&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<A)){A-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;v.dataPoints[A].label&&(a.axisX.labels[b]=v.dataPoints[A].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===
b&&p<b&&(c.viewPortMin=p):(e<d.viewPortMin&&"number"===typeof e&&(d.viewPortMin=e),e>d.viewPortMax&&"number"===typeof e&&(d.viewPortMax=e))}}v.axisX.valueType=v.xValueType=f?"dateTime":"number"}};m.prototype._processStackedPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=[],v=[],A=Infinity,k=-Infinity,n=0;n<a.dataSeriesIndexes.length;n++){var p=this.data[a.dataSeriesIndexes[n]],q=0,g=!1,r=!1,h;if("normal"===p.axisPlacement||
"xySwapped"===p.axisPlacement)var m=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,t=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?
this.options.axisX.maximum:Infinity;if(p.dataPoints[q].x&&p.dataPoints[q].x.getTime||"dateTime"===p.xValueType)f=!0;for(q=0;q<p.dataPoints.length;q++){"undefined"===typeof p.dataPoints[q].x&&(p.dataPoints[q].x=q+(a.axisX.logarithmic?1:0));p.dataPoints[q].x.getTime?(f=!0,b=p.dataPoints[q].x.getTime()):b=p.dataPoints[q].x;e=s(p.dataPoints[q].y)?0:p.dataPoints[q].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<q){if(a.axisX.logarithmic){var x=b/p.dataPoints[q-1].x;1>x&&(x=1/x);c.minDiff>x&&1!==x&&(c.minDiff=
x)}else x=b-p.dataPoints[q-1].x,0>x&&(x*=-1),c.minDiff>x&&0!==x&&(c.minDiff=x);null!==e&&null!==p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(x=e/p.dataPoints[q-1].y,1>x&&(x=1/x),d.minDiff>x&&1!==x&&(d.minDiff=x)):(x=e-p.dataPoints[q-1].y,0>x&&(x*=-1),d.minDiff>x&&0!==x&&(d.minDiff=x)))}if(b<m&&!g)null!==p.dataPoints[q].y&&(h=b);else{if(!g&&(g=!0,0<q)){q-=2;continue}if(b>t&&!r)r=!0;else if(b>t&&r)continue;p.dataPoints[q].label&&(a.axisX.labels[b]=p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=
b);b>c.viewPortMax&&(c.viewPortMax=b);null===p.dataPoints[q].y?c.viewPortMin===b&&h<b&&(c.viewPortMin=h):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,A=Math.min(e,A)):v[b]?v[b]+=e:(v[b]=e,k=Math.max(e,k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,
v)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=v));p.axisX.valueType=p.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,A)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,A)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in v)v.hasOwnProperty(q)&&!isNaN(q)&&(a=v[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,k)),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=
a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,k))))}};m.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=!1,v=!1,A=[],k=0;k<a.dataSeriesIndexes.length;k++){var n=this.data[a.dataSeriesIndexes[k]],p=0,q=!1,g=!1,r;if("normal"===n.axisPlacement||"xySwapped"===n.axisPlacement)var h=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&
this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,m=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(n.dataPoints[p].x&&n.dataPoints[p].x.getTime||"dateTime"===n.xValueType)f=!0;for(p=
0;p<n.dataPoints.length;p++){"undefined"===typeof n.dataPoints[p].x&&(n.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));n.dataPoints[p].x.getTime?(f=!0,b=n.dataPoints[p].x.getTime()):b=n.dataPoints[p].x;e=s(n.dataPoints[p].y)?null:n.dataPoints[p].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<p){if(a.axisX.logarithmic){var t=b/n.dataPoints[p-1].x;1>t&&(t=1/t);c.minDiff>t&&1!==t&&(c.minDiff=t)}else t=b-n.dataPoints[p-1].x,0>t&&(t*=-1),c.minDiff>t&&0!==t&&(c.minDiff=t);s(e)||null===n.dataPoints[p-1].y||
(a.axisY.logarithmic?0<e&&(t=e/n.dataPoints[p-1].y,1>t&&(t=1/t),d.minDiff>t&&1!==t&&(d.minDiff=t)):(t=e-n.dataPoints[p-1].y,0>t&&(t*=-1),d.minDiff>t&&0!==t&&(d.minDiff=t)))}if(b<h&&!q)null!==e&&(r=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>m&&!g)g=!0;else if(b>m&&g)continue;n.dataPoints[p].label&&(a.axisX.labels[b]=n.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&r<b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:
0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(v=!0),A[b]=A[b]?A[b]+Math.abs(e):Math.abs(e))}}n.axisX.valueType=n.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=s(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&!v?(d.max=s(d.viewPortMax)?99:Math.max(d.viewPortMax,99),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&
v?(d.max=s(d.viewPortMax)?99:Math.max(d.viewPortMax,99),d.min=s(d.viewPortMin)?-99:Math.min(d.viewPortMin,-99)):!l&&v&&(d.max=s(d.viewPortMax)?-1:Math.max(d.viewPortMax,-1),d.min=s(d.viewPortMin)?-99:Math.min(d.viewPortMin,-99));d.viewPortMin=d.min;d.viewPortMax=d.max;a.dataPointYSums=A}};m.prototype._processMultiYPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f,l,v=!1,A=0;A<a.dataSeriesIndexes.length;A++){var k=this.data[a.dataSeriesIndexes[A]],
n=0,p=!1,q=!1,g,r,h;if("normal"===k.axisPlacement||"xySwapped"===k.axisPlacement)var m=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,t=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?
this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(k.dataPoints[n].x&&k.dataPoints[n].x.getTime||"dateTime"===k.xValueType)v=!0;for(n=0;n<k.dataPoints.length;n++){"undefined"===typeof k.dataPoints[n].x&&(k.dataPoints[n].x=n+(a.axisX.logarithmic?1:0));k.dataPoints[n].x.getTime?(v=!0,b=k.dataPoints[n].x.getTime()):b=k.dataPoints[n].x;if((e=k.dataPoints[n].y)&&e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);r=!0;for(var x=
0;x<e.length;x++)null===e.k&&(r=!1);r&&(p||(h=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<n&&(a.axisX.logarithmic?(r=b/k.dataPoints[n-1].x,1>r&&(r=1/r),c.minDiff>r&&1!==r&&(c.minDiff=r)):(r=b-k.dataPoints[n-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r)),e&&(null!==e[0]&&k.dataPoints[n-1].y&&null!==k.dataPoints[n-1].y[0])&&(a.axisY.logarithmic?(r=e[0]/k.dataPoints[n-1].y[0],1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e[0]-k.dataPoints[n-1].y[0],
0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r))));if(!(b<m)||p){if(!p&&(p=!0,0<n)){n-=2;g=h;continue}if(b>t&&!q)q=!0;else if(b>t&&q)continue;k.dataPoints[n].label&&(a.axisX.labels[b]=k.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(x=0;x<e.length;x++)if(null===e[x]&&g<b){c.viewPortMin=g;break}null===e?c.viewPortMin===b&&g<b&&(c.viewPortMin=g):(f<d.viewPortMin&&(d.viewPortMin=f),l>d.viewPortMax&&(d.viewPortMax=l))}}k.axisX.valueType=
k.xValueType=v?"dateTime":"number"}};m.prototype._processSpecificPlotUnit=function(a){if("waterfall"===a.type&&a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=0;l<a.dataSeriesIndexes.length;l++){var v=this.data[a.dataSeriesIndexes[l]],A=0,k=!1,n=!1,p=b=0;if("normal"===v.axisPlacement||"xySwapped"===v.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?
this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,g=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(v.dataPoints[A].x&&v.dataPoints[A].x.getTime||"dateTime"===v.xValueType)f=!0;for(A=0;A<v.dataPoints.length;A++)"undefined"!==
...
p=0===A?0:v.dataPointEOs[A-1].cumulativeSum,b=0):(e="number"!==typeof v.dataPoints[A].y?0:v.dataPoints[A].y,v.dataPointEOs[A].cumulativeSumYStartValue=0===A?0:v.dataPointEOs[A-1].cumulativeSum,v.dataPointEOs[A].cumulativeSum=0===A?e:v.dataPointEOs[A-1].cumulativeSum+e,b+=e);for(A=0;A<v.dataPoints.length;A++)if("undefined"===typeof v.dataPoints[A].x&&(v.dataPoints[A].x=A+(a.axisX.logarithmic?1:0)),v.dataPoints[A].x.getTime?(f=!0,b=v.dataPoints[A].x.getTime()):b=v.dataPoints[A].x,e=v.dataPoints[A].y,
...
(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=v.dataPointEOs[A].cumulativeSum-v.dataPointEOs[A-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||k){if(!k&&(k=!0,0<A)){A-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;v.dataPoints[A].label&&(a.axisX.labels[b]=v.dataPoints[A].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<A&&(v.dataPointEOs[A-1].cumulativeSum<d.viewPortMin&&(d.viewPortMin=v.dataPointEOs[A-1].cumulativeSum),v.dataPointEOs[A-
1].cumulativeSum>d.viewPortMax&&(d.viewPortMax=v.dataPointEOs[A-1].cumulativeSum));v.dataPointEOs[A].cumulativeSum<d.viewPortMin&&(d.viewPortMin=v.dataPointEOs[A].cumulativeSum);v.dataPointEOs[A].cumulativeSum>d.viewPortMax&&(d.viewPortMax=v.dataPointEOs[A].cumulativeSum)}v.axisX.valueType=v.xValueType=f?"dateTime":"number"}};m.prototype.calculateAutoBreaks=function(){function a(a,b,c,e){if(e)return c=Math.pow(Math.min(c*a/b,b/a),0.2),1>=c&&(c=Math.pow(1>a?1/a:Math.min(b/a,a),0.25)),{startValue:a*
c,endValue:b/c};c=0.2*Math.min(c-b+a,b-a);0>=c&&(c=0.25*Math.min(b-a,Math.abs(a)));return{startValue:a+c,endValue:b-c}}function d(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){var b=a.axisX.scaleBreaks&&a.axisX.scaleBreaks.autoCalculate&&1<=a.axisX.scaleBreaks.maxNumberOfAutoBreaks,c=a.axisY.scaleBreaks&&a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks;if(b||c)for(var d=a.axisY.dataInfo,f=a.axisX.dataInfo,g,k=f.min,l=f.max,n=d.min,p=d.max,f=f._dataRanges,
d=d._dataRanges,q,v=0,A=0;A<a.dataSeriesIndexes.length;A++){var h=e.data[a.dataSeriesIndexes[A]];if(!(4>h.dataPoints.length))for(v=0;v<h.dataPoints.length;v++)if(b&&(q=(l+1-k)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,g=h.dataPoints[v].x.getTime?h.dataPoints[v].x.getTime():h.dataPoints[v].x,q=Math.floor((g-k)/q),g<f[q].min&&(f[q].min=g),g>f[q].max&&(f[q].max=g)),c){var m=(p+1-n)*Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold)||10,10)/100;if((g="waterfall"===
a.type?h.dataPointEOs[v].cumulativeSum:h.dataPoints[v].y)&&g.length)for(var u=0;u<g.length;u++)q=Math.floor((g[u]-n)/m),g[u]<d[q].min&&(d[q].min=g[u]),g[u]>d[q].max&&(d[q].max=g[u]);else s(g)||(q=Math.floor((g-n)/m),g<d[q].min&&(d[q].min=g),g>d[q].max&&(d[q].max=g))}}}}function c(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)&&a.axisX.scaleBreaks&&a.axisX.scaleBreaks.autoCalculate&&1<=a.axisX.scaleBreaks.maxNumberOfAutoBreaks)for(var b=a.axisX.dataInfo,c=b.min,d=b.max,f=b._dataRanges,
g,k=0,l=0;l<a.dataSeriesIndexes.length;l++){var n=e.data[a.dataSeriesIndexes[l]];if(!(4>n.dataPoints.length))for(k=0;k<n.dataPoints.length;k++)g=(d+1-c)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,b=n.dataPoints[k].x.getTime?n.dataPoints[k].x.getTime():n.dataPoints[k].x,g=Math.floor((b-c)/g),b<f[g].min&&(f[g].min=b),b>f[g].max&&(f[g].max=b)}}for(var b,e=this,f=!1,l=0;l<this._axes.length;l++)if(this._axes[l].scaleBreaks&&this._axes[l].scaleBreaks.autoCalculate&&1<=this._axes[l].scaleBreaks.maxNumberOfAutoBreaks){f=
!0;this._axes[l].dataInfo._dataRanges=[];for(var v=0;v<100/Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold)||10,10);v++)this._axes[l].dataInfo._dataRanges.push({min:Infinity,max:-Infinity})}if(f){for(l=0;l<this.plotInfo.plotTypes.length;l++)for(f=this.plotInfo.plotTypes[l],v=0;v<f.plotUnits.length;v++)b=f.plotUnits[v],"line"===b.type||"stepLine"===b.type||"spline"===b.type||"column"===b.type||"area"===b.type||"stepArea"===b.type||"splineArea"===b.type||"bar"===b.type||"bubble"===
...
n,p,f=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;n=k;for(v in q)if(q.hasOwnProperty(v)&&!isNaN(v)&&(p=q[v],!s(p))){var g=Math.floor((p-A)/b);p<n[g].min&&(n[g].min=p);p>n[g].max&&(n[g].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=this._axes[l].dataInfo.dataPointYNegativeSums;n=k;for(v in q)q.hasOwnProperty(v)&&!isNaN(v)&&(p=-1*q[v],s(p)||(g=Math.floor((p-A)/b),p<n[g].min&&
(n[g].min=p),p>n[g].max&&(n[g].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(v=0;v<k.length-1;v++)if(n=k[v].max,isFinite(n))for(;v<k.length-1;)if(A=k[v+1].min,isFinite(A)){p=A-n;p>b&&f.push({diff:p,start:n,end:A});break}else v++;if(this._axes[l].scaleBreaks.customBreaks)for(v=0;v<this._axes[l].scaleBreaks.customBreaks.length;v++)for(b=0;b<f.length;b++)if(this._axes[l].scaleBreaks.customBreaks[v].startValue<=f[b].start&&f[b].start<=this._axes[l].scaleBreaks.customBreaks[v].endValue||
this._axes[l].scaleBreaks.customBreaks[v].startValue<=f[b].start&&f[b].start<=this._axes[l].scaleBreaks.customBreaks[v].endValue||f[b].start<=this._axes[l].scaleBreaks.customBreaks[v].startValue&&this._axes[l].scaleBreaks.customBreaks[v].startValue<=f[b].end||f[b].start<=this._axes[l].scaleBreaks.customBreaks[v].endValue&&this._axes[l].scaleBreaks.customBreaks[v].endValue<=f[b].end)f.splice(b,1),b--;f.sort(function(a,b){return b.diff-a.diff});for(v=0;v<Math.min(f.length,this._axes[l].scaleBreaks.maxNumberOfAutoBreaks);v++)b=
...
(a?b[c].distance<=a.distance&&(a=b[c]):a=b[c]);return a};m.prototype.getObjectAtXY=function(a,d,c){var b=null;if(c=this.getDataPointAtXY(a,d,c||!1))b=c.dataSeries.dataPointIds[c.dataPointIndex];else if(u)b=Ya(a,d,this._eventManager.ghostCtx);else for(c=0;c<this.legend.items.length;c++){var e=this.legend.items[c];a>=e.x1&&(a<=e.x2&&d>=e.y1&&d<=e.y2)&&(b=e.id)}return b};m.prototype.getAutoFontSize=lb;m.prototype.resetOverlayedCanvas=function(){this.overlaidCanvasCtx.clearRect(0,0,this.width,this.height)};
...
l=0<=this.zoomType.indexOf("y"),v=!1,A=[],k=[],n=[],p=0;p<this._axes.length;p++)("axisX"===this._axes[p].type&&f||"axisY"===this._axes[p].type&&l)&&k.push(this._axes[p]);for(l=0;l<k.length;l++){var p=k[l],f=!1,q=p.convertPixelToValue({x:a,y:d}),g=p.convertPixelToValue({x:c,y:b});if(q>g)var r=g,g=q,q=r;if(p.scaleBreaks)for(r=0;!f&&r<p.scaleBreaks._appliedBreaks.length;r++)f=p.scaleBreaks._appliedBreaks[r].startValue<=q&&p.scaleBreaks._appliedBreaks[r].endValue>=g;if(isFinite(p.dataInfo.minDiff))if(r=
p.getApparentDifference(q,g,null,!0),!(f||!(this.panEnabled&&p.scaleBreaks&&p.scaleBreaks._appliedBreaks.length)&&(p.logarithmic&&r<Math.pow(p.dataInfo.minDiff,3)||!p.logarithmic&&r<3*Math.abs(p.dataInfo.minDiff))||q<p.minimum||g>p.maximum))A.push(p),n.push({val1:q,val2:g}),v=!0;else if(!e){v=!1;break}}return{isValid:v,axesWithValidRange:A,axesRanges:n}};m.prototype.preparePlotArea=function(){var a=this.plotArea;!u&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&
...
new Da(a.x1,a.y1,a.x2,a.y2,2)};m.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,l=f=e=0,v=0,A=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=la("indexLabelFontColor",n.dataPoint,n.dataSeries),r=la("indexLabelFontSize",n.dataPoint,n.dataSeries),v=la("indexLabelFontFamily",n.dataPoint,n.dataSeries),A=la("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=la("indexLabelFontWeight",n.dataPoint,
n.dataSeries),h=la("indexLabelBackgroundColor",n.dataPoint,n.dataSeries);q=la("indexLabelMaxWidth",n.dataPoint,n.dataSeries);g=la("indexLabelWrap",n.dataPoint,n.dataSeries);var m=la("indexLabelLineDashType",n.dataPoint,n.dataSeries),t=la("indexLabelLineColor",n.dataPoint,n.dataSeries),x=s(n.dataPoint.indexLabelLineThickness)?s(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,b=0<x?Math.min(10,("normal"===this.plotInfo.axisPlacement?
this.plotArea.height:this.plotArea.width)<<0):0,E={percent:null,total:null},B=null;if(0<=n.dataSeries.type.indexOf("stacked")||"pie"===n.dataSeries.type||"doughnut"===n.dataSeries.type)E=this.getPercentAndTotal(n.dataSeries,n.dataPoint);if(n.dataSeries.indexLabelFormatter||n.dataPoint.indexLabelFormatter)B={chart:this,dataSeries:n.dataSeries,dataPoint:n.dataPoint,index:n.indexKeyword,total:E.total,percent:E.percent};var C=n.dataPoint.indexLabelFormatter?n.dataPoint.indexLabelFormatter(B):n.dataPoint.indexLabel?
this.replaceKeywordsWithValue(n.dataPoint.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):n.dataSeries.indexLabelFormatter?n.dataSeries.indexLabelFormatter(B):n.dataSeries.indexLabel?this.replaceKeywordsWithValue(n.dataSeries.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):null;if(null!==C&&""!==C){var E=la("indexLabelPlacement",n.dataPoint,n.dataSeries),B=la("indexLabelOrientation",n.dataPoint,n.dataSeries),z=la("indexLabelTextAlign",n.dataPoint,n.dataSeries),w=n.direction,e=n.dataSeries.axisX,
f=n.dataSeries.axisY,y=!1,h=new ia(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:g?5*r:1.5*r,angle:"horizontal"===B?0:-90,text:C,padding:0,backgroundColor:h,textAlign:z,fontSize:r,fontFamily:v,fontWeight:k,fontColor:l,fontStyle:A,textBaseline:"middle"});h.measureText();n.dataSeries.indexLabelMaxWidth=h.maxWidth;if("stackedarea100"===p){if(n.point.x<c.x1||n.point.x>c.x2||n.point.y<c.y1-1||n.point.y>c.y2+1)continue}else if("rangearea"===p||"rangesplinearea"===p){if(n.dataPoint.x<e.viewportMinimum||
n.dataPoint.x>e.viewportMaximum||Math.max.apply(null,n.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,n.dataPoint.y)>f.viewportMaximum)continue}else if(0<=p.indexOf("line")||0<=p.indexOf("area")||0<=p.indexOf("bubble")||0<=p.indexOf("scatter")){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||n.dataPoint.y<f.viewportMinimum||n.dataPoint.y>f.viewportMaximum)continue}else if(0<=p.indexOf("column")||"waterfall"===p||"error"===p&&!n.axisSwapped){if(n.dataPoint.x<e.viewportMinimum||
n.dataPoint.x>e.viewportMaximum||n.bounds.y1>c.y2||n.bounds.y2<c.y1)continue}else if(0<=p.indexOf("bar")||"error"===p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||n.bounds.x1>c.x2||n.bounds.x2<c.x1)continue}else if("candlestick"===p||"ohlc"===p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||Math.max.apply(null,n.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,n.dataPoint.y)>f.viewportMaximum)continue}else if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>
e.viewportMaximum)continue;l=v=2;"horizontal"===B?(A=h.width,k=h.height):(k=h.width,A=h.height);if("normal"===this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))E="auto",v=4;else if(0<=p.indexOf("stacked"))"auto"===E&&(E="inside");else if("bubble"===p||"scatter"===p)E="inside";q=n.point.x-("horizontal"===B?A/2:A/2-r/2);"inside"!==E?(e=c.y1,f=c.y2,0<w?(g=n.point.y+("horizontal"===B?r/2:0)-k-v-b,g<e&&(g="auto"===E?Math.max(n.point.y,e)+r/2+v:e+r/2+v,y=g+k>n.point.y)):(g=n.point.y+
...
(g-k<n.point.y?0:-k)+v:(g-r/2<n.point.y?k:0)-r/2)):d.lineTo(q+A/2-("horizontal"===B?0:r/2),g+("vertical"===B?g-k<n.point.y?0:-k:(g-r/2<n.point.y?k:0)-r/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)n=this._indexLabels[a],h=la("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),n.dataSeries.indexLabelBackgroundColor=s(h)?u?"transparent":null:h;
return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,v=0;v<a.dataSeriesIndexes.length;v++){var A=a.dataSeriesIndexes[v],k=this.data[A];c.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(c.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,
g=N(p,k.lineThickness);c.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:A};r=P(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,t=0,x,s;c.beginPath();if(0<n.length){for(var B=!1,t=0;t<n.length;t++)if(x=n[t].x.getTime?n[t].x.getTime():n[t].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||
!B)))if("number"!==typeof n[t].y)0<t&&!(k.connectNullData||B||m)&&(c.stroke(),u&&b.stroke()),B=!0;else{x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(n[t].y);var C=k.dataPointIds[t];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:t,x1:x,y1:s};m||B?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,
c.setLineDash(q)),c.lineTo(x,s),u&&b.lineTo(x,s)):(c.beginPath(),c.moveTo(x,s),u&&(b.beginPath(),b.moveTo(x,s))),B=m=!1):(c.lineTo(x,s),u&&b.lineTo(x,s),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),u&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));l={x:x,y:s};t<n.length-1&&(h!==(n[t].lineColor||r)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,s),h=n[t].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(N(p,k.lineThickness))):
(p=k.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<k.markerSize){var z=k.getMarkerProperties(t,x,s,c);f.push(z);C=P(C);u&&f.push({x:x,y:s,ctx:b,type:z.type,size:z.size,color:C,borderColor:C,borderThickness:z.borderThickness})}(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[t],dataSeries:k,point:{x:x,y:s},direction:0>n[t].y===a.axisY.reversed?1:-1,color:r})}c.stroke();u&&b.stroke()}}V.drawMarkers(f);u&&
...
easingFunction:K.easing.linear,animationBase:0}}};m.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,v=0;v<a.dataSeriesIndexes.length;v++){var A=a.dataSeriesIndexes[v],k=this.data[A];c.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(c.setLineDash){var q=N(k.nullDataLineDashType,
...
(!k.connectNullData||!B)))if("number"!==typeof n[t].y)0<t&&!(k.connectNullData||B||m)&&(c.stroke(),u&&b.stroke()),B=!0;else{var C=s;x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(n[t].y);var z=k.dataPointIds[t];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:t,x1:x,y1:s};m||B?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,
l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,C),c.lineTo(x,s),u&&(b.lineTo(x,C),b.lineTo(x,s))):(c.beginPath(),c.moveTo(x,s),u&&(b.beginPath(),b.moveTo(x,s))),B=m=!1):(c.lineTo(x,C),u&&b.lineTo(x,C),c.lineTo(x,s),u&&b.lineTo(x,s),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),u&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));l={x:x,y:s};t<n.length-1&&(h!==(n[t].lineColor||r)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,s),h=n[t].lineColor||r,c.strokeStyle=
h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(N(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<k.markerSize)C=k.getMarkerProperties(t,x,s,c),f.push(C),z=P(z),u&&f.push({x:x,y:s,ctx:b,type:C.type,size:C.size,color:z,borderColor:z,borderThickness:C.borderThickness});(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[t],dataSeries:k,point:{x:x,y:s},direction:0>
n[t].y===a.axisY.reversed?1:-1,color:r})}c.stroke();u&&b.stroke()}}V.drawMarkers(f);u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());
c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};m.prototype.renderSpline=function(a){function d(a){a=w(a,2);if(0<a.length){b.beginPath();u&&e.beginPath();b.moveTo(a[0].x,a[0].y);a[0].newStrokeStyle&&(b.strokeStyle=a[0].newStrokeStyle);a[0].newLineDashArray&&b.setLineDash(a[0].newLineDashArray);u&&e.moveTo(a[0].x,a[0].y);for(var c=0;c<a.length-3;c+=3)if(b.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+2].x,a[c+
...
this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],v=0;v<a.dataSeriesIndexes.length;v++){var A=a.dataSeriesIndexes[v],k=this.data[A];b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=N(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:A};r=P(r);e.strokeStyle=r;e.lineWidth=
...
1].newLineDashArray=q,p=k.nullDataLineDashType):(d(s),s=[])),x=!0;else{t=a.axisX.convertValueToPixel(t);x=a.axisY.convertValueToPixel(n[m].y);var B=k.dataPointIds[m];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:m,x1:t,y1:x};s[s.length]={x:t,y:x};m<n.length-1&&(h!==(n[m].lineColor||r)||p!==(n[m].lineDashType||k.lineDashType))&&(h=n[m].lineColor||r,s[s.length-1].newStrokeStyle=h,b.setLineDash&&(n[m].lineDashType?(p=n[m].lineDashType,s[s.length-1].newLineDashArray=
N(p,k.lineThickness)):(p=k.lineDashType,s[s.length-1].newLineDashArray=g)));if(0<n[m].markerSize||0<k.markerSize){var C=k.getMarkerProperties(m,t,x,b);l.push(C);B=P(B);u&&l.push({x:t,y:x,ctx:e,type:C.type,size:C.size,color:B,borderColor:B,borderThickness:C.borderThickness})}(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:k,point:{x:t,y:x},direction:0>n[m].y===a.axisY.reversed?1:-1,color:r});x=!1}d(s)}V.drawMarkers(l);
...
easingFunction:K.easing.linear,animationBase:0}}};m.prototype.renderColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,v,A,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:
...
n<f)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));p<f&&(p=f);p>n&&(p=n);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],r=g.dataPoints;if(0<r.length)for(var h=5<p&&g.bevelEnabled?!0:!1,f=
0;f<r.length;f++)if(r[f].getTime?A=r[f].x.getTime():A=r[f].x,!(A<a.axisX.dataInfo.viewPortMin||A>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(A);v=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?l-p<<0:l+p<<0,t;0<=r[f].y?t=k:(t=v,v=k);v>t&&(b=v,v=t,t=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];
ca(c,l,v,m,t,b,0,null,h&&0<=r[f].y,0>r[f].y&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:v,x2:m,y2:t};b=P(b);u&&ca(this._eventManager.ghostCtx,l,v,m,t,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:r[f],dataSeries:g,point:{x:l+(m-l)/2,y:0>r[f].y===a.axisY.reversed?v:t},direction:0>r[f].y===
a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(v,t),x2:m,y2:Math.max(v,t)},color:b})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.yScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:k<a.axisY.bounds.y1?a.axisY.bounds.y1:k>a.axisY.bounds.y2?a.axisY.bounds.y2:k}}};m.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],v=[],A=[],k=0,n,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=
...
a.dataSeriesIndexes[r],m=this.data[h],t=m.dataPoints;if(0<t.length){var x=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);var s=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,B=s+g<<0,C;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)v[b]=t[k].y+(v[b]?v[b]:
0),0<v[b]&&(p=a.axisY.convertValueToPixel(v[b]),C="undefined"!==typeof f[b]?f[b]:q,f[b]=p);else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)A[b]=t[k].y+(A[b]?A[b]:0),C=a.axisY.convertValueToPixel(A[b]),p="undefined"!==typeof l[b]?l[b]:q,l[b]=C;else if(p=a.axisY.convertValueToPixel(t[k].y),0<=t[k].y){var z="undefined"!==typeof f[b]?f[b]:0;p-=z;C=q-z;f[b]=z+(C-p)}else z=l[b]?l[b]:0,C=p+z,p=q+z,l[b]=z+(C-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];
ca(c,s,p,B,C,b,0,null,x&&0<=t[k].y,0>t[k].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:s,y1:p,x2:B,y2:C};b=P(b);u&&ca(this._eventManager.ghostCtx,s,p,B,C,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:t[k],dataSeries:m,point:{x:n,y:0<=t[k].y?p:C},direction:0>t[k].y===a.axisY.reversed?
1:-1,bounds:{x1:s,y1:Math.min(p,C),x2:B,y2:Math.max(p,C)},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.yScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],v=[],A=[],k=0,n,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&
k>n&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<k)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));g<k&&(g=k);g>n&&(g=n);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=
a.dataSeriesIndexes[r],m=this.data[h],t=m.dataPoints;if(0<t.length)for(var x=5<g&&m.bevelEnabled?!0:!1,k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(t[k].y/a.dataPointYSums[b]):0;var s=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,B=s+g<<0,C;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
0<t[k].y){v[b]=p+("undefined"!==typeof v[b]?v[b]:0);if(0>=v[b])continue;p=a.axisY.convertValueToPixel(v[b]);C=f[b]?f[b]:q;f[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)A[b]=p+("undefined"!==typeof A[b]?A[b]:0),C=a.axisY.convertValueToPixel(A[b]),p=l[b]?l[b]:q,l[b]=C;else if(p=a.axisY.convertValueToPixel(p),0<=t[k].y){var z="undefined"!==typeof f[b]?f[b]:0;p-=z;C=q-z;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y1-p)&&(p=e.y1);f[b]=z+(C-p)}else z="undefined"!==
typeof l[b]?l[b]:0,C=p+z,p=q+z,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y2-C)&&(C=e.y2),l[b]=z+(C-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,s,p,B,C,b,0,null,x&&0<=t[k].y,0>t[k].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:s,y1:p,x2:B,y2:C};b=P(b);u&&ca(this._eventManager.ghostCtx,s,p,B,C,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&
this._indexLabels.push({chartType:"stackedColumn100",dataPoint:t[k],dataSeries:m,point:{x:n,y:0<=t[k].y?p:C},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:s,y1:Math.min(p,C),x2:B,y2:Math.max(p,C)},color:b})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.yScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
null,e=this.plotArea,f=0,l,v,A,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.height,0.9*(this.plotArea.height/a.plotType.totalDataSeries))<<0,p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.options.dataPointWidth?
this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(p)/Math.log(a.axisX.range):Math.abs(p)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>n&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<f)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));p<f&&(p=f);p>n&&(p=n);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);
c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],r=g.dataPoints;if(0<r.length){var h=5<p&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<r.length;f++)if(r[f].getTime?A=r[f].x.getTime():A=r[f].x,!(A<a.axisX.dataInfo.viewPortMin||A>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){v=a.axisX.convertValueToPixel(A);
l=a.axisY.convertValueToPixel(r[f].y);v=a.axisX.reversed?v+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:v-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?v-p<<0:v+p<<0,t;0<=r[f].y?t=k:(t=l,l=k);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ca(c,t,v,l,m,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:t,y1:v,x2:l,y2:m};b=
P(b);u&&ca(this._eventManager.ghostCtx,t,v,l,m,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:r[f],dataSeries:g,point:{x:0<=r[f].y?l:t,y:v+(m-v)/2},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(t,l),y1:v,x2:Math.max(t,l),y2:m},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
k&&(g=k);g>p&&(g=p);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],m=this.data[h],t=m.dataPoints;if(0<t.length){var x=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():
t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){p=a.axisX.convertValueToPixel(b);var s=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,B=s+g<<0,C;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)v[b]=t[k].y+(v[b]?v[b]:0),0<v[b]&&(C=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(v[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)A[b]=t[k].y+(A[b]?A[b]:0),n=l[b]?
l[b]:q,l[b]=C=a.axisY.convertValueToPixel(A[b]);else if(n=a.axisY.convertValueToPixel(t[k].y),0<=t[k].y){var z=f[b]?f[b]:0;C=q+z;n+=z;f[b]=z+(n-C)}else z=l[b]?l[b]:0,C=n-z,n=q-z,l[b]=z+(n-C);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,C,s,n,B,b,0,null,x,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:C,y1:s,x2:n,y2:B};b=P(b);u&&ca(this._eventManager.ghostCtx,C,s,n,B,b,0,null,!1,!1,!1,
!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:C,y:p},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(C,n),y1:s,x2:Math.max(C,n),y2:B},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&k>p&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,p));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&p<k)&&(p=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));g<k&&(g=k);g>p&&(g=p);c.save();u&&this._eventManager.ghostCtx.save();
c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],m=this.data[h],t=m.dataPoints;if(0<t.length){var s=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&
"number"===typeof t[k].y){p=a.axisX.convertValueToPixel(b);var E;E=0!==a.dataPointYSums[b]?100*(t[k].y/a.dataPointYSums[b]):0;var B=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=B+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y){v[b]=E+(v[b]?v[b]:0);if(0>=v[b])continue;E=f[b]?f[b]:q;f[b]=n=a.axisY.convertValueToPixel(v[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)A[b]=E+(A[b]?A[b]:0),n=l[b]?l[b]:
q,l[b]=E=a.axisY.convertValueToPixel(A[b]);else if(n=a.axisY.convertValueToPixel(E),0<=t[k].y){var z=f[b]?f[b]:0;E=q+z;n+=z;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=z+(n-E)}else z=l[b]?l[b]:0,E=n-z,n=q-z,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x1-E)&&(E=e.x1),l[b]=z+(n-E);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,E,B,n,C,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,
dataPointIndex:k,x1:E,y1:B,x2:n,y2:C};b=P(b);u&&ca(this._eventManager.ghostCtx,E,B,n,C,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:E,y:p},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(E,n),y1:B,x2:Math.max(E,n),y2:C},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=function(a){var d,c;function b(){C&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?B=E:0>a.axisY.viewportMaximum?B=v.y1:0<a.axisY.viewportMinimum&&(B=E),f.lineTo(m,B),f.lineTo(C.x,B),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,u&&(l.lineTo(m,B),l.lineTo(C.x,B),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,t),l.beginPath(),l.moveTo(m,t),C={x:m,y:t})}
var e=a.targetCanvasCtx||this.plotArea.ctx,f=u?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,v=a.axisY.lineCoordinates,A=[],k=this.plotArea,n;f.save();u&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();u&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};
A=P(A);l.fillStyle=A;A=[];d=!0;var h=0,m,t,s,E=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),B,C=null;if(0<r.length){var z=g._colorSet[h%g._colorSet.length],w=g.lineColor=g.options.lineColor||z,y=w;f.fillStyle=z;f.strokeStyle=w;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var Q=N(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var aa=N(c,g.lineThickness);f.setLineDash(aa)}for(var ja=!0;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<
a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ja)))if("number"!==typeof r[h].y)g.connectNullData||(ja||d)||b(),ja=!0;else{m=a.axisX.convertValueToPixel(s);t=a.axisY.convertValueToPixel(r[h].y);d||ja?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),f.moveTo(n.x,n.y),m=d,t=c,C=n,c=g.nullDataLineDashType,f.setLineDash(Q)),f.lineTo(m,t),u&&l.lineTo(m,t)):
(f.beginPath(),f.moveTo(m,t),u&&(l.beginPath(),l.moveTo(m,t)),C={x:m,y:t}),ja=d=!1):(f.lineTo(m,t),u&&l.lineTo(m,t),0==h%250&&b());n={x:m,y:t};h<r.length-1&&(y!==(r[h].lineColor||w)||c!==(r[h].lineDashType||g.lineDashType))&&(b(),y=r[h].lineColor||w,f.strokeStyle=y,f.setLineDash&&(r[h].lineDashType?(c=r[h].lineDashType,f.setLineDash(N(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(aa))));var Y=g.dataPointIds[h];this._eventManager.objectMap[Y]={id:Y,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,
x1:m,y1:t};0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,m,t,f),A.push(s),Y=P(Y),u&&A.push({x:m,y:t,ctx:l,type:s.type,size:s.size,color:Y,borderColor:Y,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:m,y:t},direction:0>r[h].y===a.axisY.reversed?1:-1,color:z})}b();V.drawMarkers(A)}}u&&(e.drawImage(this._preRenderCanvas,
...
m=h:0>a.axisY.viewportMaximum?m=f.y1:0<a.axisY.viewportMinimum&&(m=h);t={x:c[0].x,y:c[0].y};b.lineTo(c[c.length-1].x,m);b.lineTo(t.x,m);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;u&&(e.lineTo(c[c.length-1].x,m),e.lineTo(t.x,m),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=a.axisY.lineCoordinates,l=[],v=this.plotArea;b.save();u&&e.save();b.beginPath();b.rect(v.x1,
v.y1,v.width,v.height);b.clip();u&&(e.beginPath(),e.rect(v.x1,v.y1,v.width,v.height),e.clip());for(var A=0;A<a.dataSeriesIndexes.length;A++){var k=a.dataSeriesIndexes[A],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=P(l);e.fillStyle=l;var l=[],q=0,g,r,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,t=null,s=[];if(0<p.length){var E=n._colorSet[q%n._colorSet.length],B=n.lineColor=n.options.lineColor||
E,C=B;b.fillStyle=E;b.strokeStyle=B;b.lineWidth=n.lineThickness;var z="solid";if(b.setLineDash){var y=N(n.nullDataLineDashType,n.lineThickness),z=n.lineDashType,D=N(z,n.lineThickness);b.setLineDash(D)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(n.connectNullData?b.setLineDash&&(0<s.length&&(n.options.nullDataLineDashType||!p[q-1].lineDashType))&&
(s[s.length-1].newLineDashArray=y,z=n.nullDataLineDashType):(d(),s=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);var Q=n.dataPointIds[q];this._eventManager.objectMap[Q]={id:Q,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};s[s.length]={x:g,y:r};q<p.length-1&&(C!==(p[q].lineColor||B)||z!==(p[q].lineDashType||n.lineDashType))&&(C=p[q].lineColor||B,s[s.length-1].newStrokeStyle=C,b.setLineDash&&(p[q].lineDashType?(z=p[q].lineDashType,s[s.length-
1].newLineDashArray=N(z,n.lineThickness)):(z=n.lineDashType,s[s.length-1].newLineDashArray=D)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(q,g,r,b);l.push(aa);Q=P(Q);u&&l.push({x:g,y:r,ctx:e,type:aa.type,size:aa.size,color:Q,borderColor:Q,borderThickness:aa.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,point:{x:g,y:r},direction:0>
p[q].y===a.axisY.reversed?1:-1,color:E});r=!1}d();V.drawMarkers(l)}}u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(v.x1,v.y1,v.width,v.height),this._eventManager.ghostCtx.restore());
b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};m.prototype.renderStepArea=function(a){var d,c;function b(){C&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?B=E:0>a.axisY.viewportMaximum?B=v.y1:0<a.axisY.viewportMinimum&&(B=E),f.lineTo(m,B),f.lineTo(C.x,B),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,u&&(l.lineTo(m,B),l.lineTo(C.x,
...
g=this.data[q],r=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};A=P(A);l.fillStyle=A;A=[];d=!0;var h=0,m,t,s,E=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),B,C=null;c=!1;if(0<r.length){var z=g._colorSet[h%g._colorSet.length],w=g.lineColor=g.options.lineColor||z,y=w;f.fillStyle=z;f.strokeStyle=w;f.lineWidth=g.lineThickness;var Q="solid";if(f.setLineDash){var aa=N(g.nullDataLineDashType,g.lineThickness),Q=g.lineDashType,
D=N(Q,g.lineThickness);f.setLineDash(D)}for(;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var Y=t;"number"!==typeof r[h].y?(g.connectNullData||(c||d)||b(),c=!0):(m=a.axisX.convertValueToPixel(s),t=a.axisY.convertValueToPixel(r[h].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||Q===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),
...
dataPoint:r[h],dataSeries:g,point:{x:m,y:t},direction:0>r[h].y===a.axisY.reversed?1:-1,color:z}))}b();V.drawMarkers(A)}}u&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(k.x1,
k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};m.prototype.renderStackedArea=function(a){function d(){if(!(1>k.length)){for(0<z.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);u&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=z.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();u&&(s.closePath(),s.fill(),s.beginPath());k=[]}}var c=
a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],v=this.plotArea,h=[],k=[],n=[],p=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),s=this._eventManager.ghostCtx,t,x,E;u&&s.beginPath();b.save();u&&s.save();b.beginPath();b.rect(v.x1,v.y1,v.width,v.height);b.clip();u&&(s.beginPath(),s.rect(v.x1,v.y1,v.width,v.height),s.clip());for(var e=[],B=0;B<a.dataSeriesIndexes.length;B++){var C=a.dataSeriesIndexes[B],
z=this.data[C],w=z.dataPoints;z.dataPointIndexes=[];for(q=0;q<w.length;q++)C=w[q].x.getTime?w[q].x.getTime():w[q].x,z.dataPointIndexes[C]=q,e[C]||(n.push(C),e[C]=!0);n.sort(Pa)}for(B=0;B<a.dataSeriesIndexes.length;B++){C=a.dataSeriesIndexes[B];z=this.data[C];w=z.dataPoints;x=!0;k=[];q=z.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:C};q=P(q);s.fillStyle=q;if(0<n.length){var e=z._colorSet[0],y=z.lineColor=z.options.lineColor||e,Q=y;b.fillStyle=e;b.strokeStyle=y;b.lineWidth=
z.lineThickness;E="solid";if(b.setLineDash){var aa=N(z.nullDataLineDashType,z.lineThickness);E=z.lineDashType;var D=N(E,z.lineThickness);b.setLineDash(D)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],fa=null,fa=0<=z.dataPointIndexes[f]?w[z.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!z.connectNullData||!Y)))if("number"!==typeof fa.y)z.connectNullData||(Y||x)||d(),Y=!0;else{g=a.axisX.convertValueToPixel(f);var ma=h[f]?h[f]:0;if(a.axisY.logarithmic||
a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=fa.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(fa.y),r-=ma;k.push({x:g,y:m-ma});h[f]=m-r;x||Y?(!x&&z.connectNullData?(b.setLineDash&&(z.options.nullDataLineDashType||E===z.lineDashType&&z.lineDashType!==z.nullDataLineDashType)&&(x=k.pop(),E=k[k.length-1],d(),b.moveTo(t.x,t.y),k.push(E),k.push(x),E=z.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,
r),u&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),u&&(s.beginPath(),s.moveTo(g,r))),Y=x=!1):(b.lineTo(g,r),u&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),u&&s.moveTo(g,r),k.push({x:g,y:m-ma})));t={x:g,y:r};q<w.length-1&&(Q!==(w[q].lineColor||y)||E!==(w[q].lineDashType||z.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:m-ma}),Q=w[q].lineColor||y,b.strokeStyle=Q,b.setLineDash&&(w[q].lineDashType?(E=w[q].lineDashType,b.setLineDash(N(E,z.lineThickness))):(E=z.lineDashType,b.setLineDash(D))));
if(0<=z.dataPointIndexes[f]){var F=z.dataPointIds[z.dataPointIndexes[f]];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:z.dataPointIndexes[f],x1:g,y1:r}}0<=z.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<z.markerSize)&&(ma=z.getMarkerProperties(z.dataPointIndexes[f],g,r,b),l.push(ma),f=P(F),u&&l.push({x:g,y:r,ctx:s,type:ma.type,size:ma.size,color:f,borderColor:f,borderThickness:ma.borderThickness}));(fa.indexLabel||z.indexLabel||fa.indexLabelFormatter||
z.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:fa,dataSeries:z,point:{x:g,y:r},direction:0>w[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);u&&s.moveTo(g,r)}delete z.dataPointIndexes}V.drawMarkers(l);u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(v.x1,v.y1,v.width,v.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<z.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);u&&E.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=z.fillOpacity;b.fill();
b.globalAlpha=1;b.beginPath();u&&(E.closePath(),E.fill(),E.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,v=[],h=[],k=[],n=[],p=[],q=0,g,r,m,s,t,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),E=this._eventManager.ghostCtx;b.save();u&&E.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();u&&(E.beginPath(),E.rect(l.x1,l.y1,l.width,l.height),E.clip());
for(var e=[],B=0;B<a.dataSeriesIndexes.length;B++){var w=a.dataSeriesIndexes[B],z=this.data[w],y=z.dataPoints;z.dataPointIndexes=[];for(q=0;q<y.length;q++)w=y[q].x.getTime?y[q].x.getTime():y[q].x,z.dataPointIndexes[w]=q,e[w]||(n.push(w),e[w]=!0);n.sort(Pa)}for(B=0;B<a.dataSeriesIndexes.length;B++){w=a.dataSeriesIndexes[B];z=this.data[w];y=z.dataPoints;s=!0;e=z.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:w};e=P(e);E.fillStyle=e;k=[];if(0<n.length){var e=z._colorSet[q%
z._colorSet.length],D=z.lineColor=z.options.lineColor||e,Q=D;b.fillStyle=e;b.strokeStyle=D;b.lineWidth=z.lineThickness;t="solid";if(b.setLineDash){var aa=N(z.nullDataLineDashType,z.lineThickness);t=z.lineDashType;var F=N(t,z.lineThickness);b.setLineDash(F)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],fa=null,fa=0<=z.dataPointIndexes[f]?y[z.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!z.connectNullData||!Y)))if("number"!==typeof fa.y)z.connectNullData||
(Y||s)||d(),Y=!0;else{var ma;ma=0!==a.dataPointYSums[f]?100*(fa.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var ba=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ma+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(ma),r-=ba;k.push({x:g,y:x-ba});h[f]=x-r;s||Y?(!s&&z.connectNullData?(b.setLineDash&&(z.options.nullDataLineDashType||t===z.lineDashType&&
z.lineDashType!==z.nullDataLineDashType)&&(s=k.pop(),t=k[k.length-1],d(),b.moveTo(m.x,m.y),k.push(t),k.push(s),t=z.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),u&&E.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),u&&(E.beginPath(),E.moveTo(g,r))),Y=s=!1):(b.lineTo(g,r),u&&E.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),u&&E.moveTo(g,r),k.push({x:g,y:x-ba})));m={x:g,y:r};q<y.length-1&&(Q!==(y[q].lineColor||D)||t!==(y[q].lineDashType||z.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:x-
ba}),Q=y[q].lineColor||D,b.strokeStyle=Q,b.setLineDash&&(y[q].lineDashType?(t=y[q].lineDashType,b.setLineDash(N(t,z.lineThickness))):(t=z.lineDashType,b.setLineDash(F))));if(0<=z.dataPointIndexes[f]){var G=z.dataPointIds[z.dataPointIndexes[f]];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:z.dataPointIndexes[f],x1:g,y1:r}}0<=z.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<z.markerSize)&&(ba=z.getMarkerProperties(q,g,r,b),v.push(ba),f=P(G),
u&&v.push({x:g,y:r,ctx:E,type:ba.type,size:ba.size,color:f,borderColor:f,borderThickness:ba.borderThickness}));(fa.indexLabel||z.indexLabel||fa.indexLabelFormatter||z.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:fa,dataSeries:z,point:{x:g,y:r},direction:0>y[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);u&&E.moveTo(g,r)}delete z.dataPointIndexes}V.drawMarkers(v);u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
"source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),E.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};m.prototype.renderBubble=function(a){var d=
...
f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof q[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(q[e].y);var g=q[e].z,s=2*Math.max(Math.sqrt((v===h?m/2:r+(m-r)/(v-h)*(g-h))/Math.PI)<<0,1),g=p.getMarkerProperties(e,c);g.size=s;c.globalAlpha=p.fillOpacity;V.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var t=p.dataPointIds[e];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:e,x1:f,y1:l,size:s};
s=P(t);u&&V.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,s,s,g.borderThickness);(q[e].indexLabel||p.indexLabel||q[e].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:q[e],dataSeries:p,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null})}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var h=a.dataSeriesIndexes[v],k=this.data[h],n=k.dataPoints;if(0<n.length){c.strokeStyle="#4572A7 ";Math.pow(0.3*Math.min(b.height,
b.width)/2,2);for(var p=0,q=0,e=0;e<n.length;e++)if(f=n[e].getTime?f=n[e].x.getTime():f=n[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof n[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(n[e].y);var g=k.getMarkerProperties(e,f,l,c);c.globalAlpha=k.fillOpacity;V.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((p-f)*(p-f)+(q-l)*(q-l))<Math.min(g.size,5)&&n.length>Math.min(this.plotArea.width,
...
p=f,q=l)}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,
animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};m.prototype.renderCandlestick=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,v=0,h,k,n,p,q,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,f=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?
...
e&&(r=e);r>f&&(r=f);c.save();u&&b.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();u&&(b.beginPath(),b.rect(l.x1,l.y1,l.width,l.height),b.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var w=a.dataSeriesIndexes[m],t=this.data[w],x=t.dataPoints;if(0<x.length)for(var E=5<r&&t.bevelEnabled?!0:!1,v=0;v<x.length;v++)if(x[v].getTime?g=x[v].x.getTime():g=x[v].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(x[v].y)&&x[v].y.length&&"number"===typeof x[v].y[0]&&
"number"===typeof x[v].y[1]&&"number"===typeof x[v].y[2]&&"number"===typeof x[v].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(x[v].y[0]);n=a.axisY.convertValueToPixel(x[v].y[1]);p=a.axisY.convertValueToPixel(x[v].y[2]);q=a.axisY.convertValueToPixel(x[v].y[3]);var B=h-r/2<<0,C=B+r<<0,f=t.options.fallingColor?t.fallingColor:t._colorSet[0],e=x[v].color?x[v].color:t._colorSet[0],z=Math.round(Math.max(1,0.15*r)),y=0===z%2?0:0.5,D=t.dataPointIds[v];this._eventManager.objectMap[D]=
{id:D,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:v,x1:B,y1:k,x2:C,y2:n,x3:h,y3:p,x4:h,y4:q,borderThickness:z,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=z;b.lineWidth=Math.max(z,4);"candlestick"===t.type?(c.moveTo(h-y,n),c.lineTo(h-y,Math.min(k,q)),c.stroke(),c.moveTo(h-y,Math.max(k,q)),c.lineTo(h-y,p),c.stroke(),ca(c,B,Math.min(k,q),C,Math.max(k,q),x[v].y[0]<=x[v].y[3]?t.risingColor:f,z,e,E,E,!1,!1,t.fillOpacity),u&&(e=P(D),b.strokeStyle=e,b.moveTo(h-y,n),b.lineTo(h-y,Math.min(k,
q)),b.stroke(),b.moveTo(h-y,Math.max(k,q)),b.lineTo(h-y,p),b.stroke(),ca(b,B,Math.min(k,q),C,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===t.type&&(c.moveTo(h-y,n),c.lineTo(h-y,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(B,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(C,q),c.stroke(),u&&(e=P(D),b.strokeStyle=e,b.moveTo(h-y,n),b.lineTo(h-y,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(B,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(C,q),b.stroke()));(x[v].indexLabel||t.indexLabel||
x[v].indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:t.type,dataPoint:x[v],dataSeries:t,point:{x:B+(C-B)/2,y:a.axisY.reversed?p:n},direction:1,bounds:{x1:B,y1:Math.min(n,p),x2:C,y2:Math.max(n,p)},color:e})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),b.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};m.prototype.renderBoxAndWhisker=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=this.plotArea,
l=0,v,h,k,n,p,q,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.015*this.width,r=a.axisX.dataInfo.minDiff;isFinite(r)||(r=0.3*Math.abs(a.axisX.range));r=this.options.dataPointWidth?this.dataPointWidth:0.7*f.width*(a.axisX.logarithmic?Math.log(r)/Math.log(a.axisX.range):Math.abs(r)/Math.abs(a.axisX.range))<<0;this.dataPointMaxWidth&&e>
l&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<e)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));r<e&&(r=e);r>l&&(r=l);c.save();u&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();u&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var m=!1,m=!!a.axisY.reversed,w=0;w<a.dataSeriesIndexes.length;w++){var t=a.dataSeriesIndexes[w],x=this.data[t],E=x.dataPoints;
if(0<E.length)for(var B=5<r&&x.bevelEnabled?!0:!1,l=0;l<E.length;l++)if(E[l].getTime?g=E[l].x.getTime():g=E[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(E[l].y)&&E[l].y.length&&"number"===typeof E[l].y[0]&&"number"===typeof E[l].y[1]&&"number"===typeof E[l].y[2]&&"number"===typeof E[l].y[3]&&"number"===typeof E[l].y[4]&&5===E[l].y.length){v=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(E[l].y[0]);k=a.axisY.convertValueToPixel(E[l].y[1]);n=a.axisY.convertValueToPixel(E[l].y[2]);
p=a.axisY.convertValueToPixel(E[l].y[3]);q=a.axisY.convertValueToPixel(E[l].y[4]);var C=v-r/2<<0,z=v+r/2<<0,e=E[l].color?E[l].color:x._colorSet[0],y=Math.round(Math.max(1,0.15*r)),D=0===y%2?0:0.5,Q=E[l].whiskerColor?E[l].whiskerColor:E[l].color?x.whiskerColor?x.whiskerColor:E[l].color:x.whiskerColor?x.whiskerColor:e,aa="number"===typeof E[l].whiskerThickness?E[l].whiskerThickness:"number"===typeof x.options.whiskerThickness?x.whiskerThickness:y,F=E[l].whiskerDashType?E[l].whiskerDashType:x.whiskerDashType,
Y=s(E[l].whiskerLength)?s(x.options.whiskerLength)?r:x.whiskerLength:E[l].whiskerLength,Y="number"===typeof Y?0>=Y?0:Y>=r?r:Y:"string"===typeof Y?parseInt(Y)*r/100>r?r:parseInt(Y)*r/100:r,fa=1===Math.round(aa)%2?0.5:0,ma=E[l].stemColor?E[l].stemColor:E[l].color?x.stemColor?x.stemColor:E[l].color:x.stemColor?x.stemColor:e,ba="number"===typeof E[l].stemThickness?E[l].stemThickness:"number"===typeof x.options.stemThickness?x.stemThickness:y,G=1===Math.round(ba)%2?0.5:0,J=E[l].stemDashType?E[l].stemDashType:
x.stemDashType,H=E[l].lineColor?E[l].lineColor:E[l].color?x.lineColor?x.lineColor:E[l].color:x.lineColor?x.lineColor:e,M="number"===typeof E[l].lineThickness?E[l].lineThickness:"number"===typeof x.options.lineThickness?x.lineThickness:y,S=E[l].lineDashType?E[l].lineDashType:x.lineDashType,L=1===Math.round(M)%2?0.5:0,R=x.upperBoxColor,xa=x.lowerBoxColor,sa=s(x.options.fillOpacity)?1:x.fillOpacity,O=x.dataPointIds[l];this._eventManager.objectMap[O]={id:O,objectType:"dataPoint",dataSeriesIndex:t,dataPointIndex:l,
x1:C,y1:h,x2:z,y2:k,x3:v,y3:n,x4:v,y4:p,y5:q,borderThickness:y,color:e,stemThickness:ba,stemColor:ma,whiskerThickness:aa,whiskerLength:Y,whiskerColor:Q,lineThickness:M,lineColor:H};c.save();0<ba&&(c.beginPath(),c.strokeStyle=ma,c.lineWidth=ba,c.setLineDash&&c.setLineDash(N(J,ba)),c.moveTo(v-G,k),c.lineTo(v-G,h),c.stroke(),c.moveTo(v-G,p),c.lineTo(v-G,n),c.stroke());c.restore();b.lineWidth=Math.max(y,4);c.beginPath();ca(c,C,Math.min(q,k),z,Math.max(k,q),xa,0,e,m?B:!1,m?!1:B,!1,!1,sa);c.beginPath();
ca(c,C,Math.min(n,q),z,Math.max(q,n),R,0,e,m?!1:B,m?B:!1,!1,!1,sa);c.beginPath();c.lineWidth=y;c.strokeStyle=e;c.rect(C-D,Math.min(k,n)-D,z-C+2*D,Math.max(k,n)-Math.min(k,n)+2*D);c.stroke();c.save();0<M&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(N(S,M)),c.strokeStyle=H,c.lineWidth=M,c.moveTo(C,q-L),c.lineTo(z,q-L),c.stroke());c.restore();c.save();0<aa&&(c.beginPath(),c.setLineDash&&c.setLineDash(N(F,aa)),c.strokeStyle=Q,c.lineWidth=aa,c.moveTo(v-Y/2<<0,p-fa),c.lineTo(v+Y/2<<0,p-
fa),c.stroke(),c.moveTo(v-Y/2<<0,h+fa),c.lineTo(v+Y/2<<0,h+fa),c.stroke());c.restore();u&&(e=P(O),b.strokeStyle=e,b.lineWidth=ba,0<ba&&(b.moveTo(v-D-G,k),b.lineTo(v-D-G,Math.max(h,p)),b.stroke(),b.moveTo(v-D-G,Math.min(h,p)),b.lineTo(v-D-G,n),b.stroke()),ca(b,C,Math.max(k,n),z,Math.min(k,n),e,0,null,!1,!1,!1,!1),0<aa&&(b.beginPath(),b.lineWidth=aa,b.moveTo(v+Y/2,p-fa),b.lineTo(v-Y/2,p-fa),b.stroke(),b.moveTo(v+Y/2,h+fa),b.lineTo(v-Y/2,h+fa),b.stroke()));(E[l].indexLabel||x.indexLabel||E[l].indexLabelFormatter||
x.indexLabelFormatter)&&this._indexLabels.push({chartType:x.type,dataPoint:E[l],dataSeries:x,point:{x:C+(z-C)/2,y:a.axisY.reversed?h:p},direction:1,bounds:{x1:C,y1:Math.min(h,p),x2:z,y2:Math.max(h,p)},color:e})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),b.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,v,h,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:
...
(this.dataPointMinWidth&&l<f)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));k<f&&(k=f);k>l&&(k=l);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var p=a.dataSeriesIndexes[n],q=this.data[p],g=q.dataPoints;if(0<g.length)for(var r=
5<k&&q.bevelEnabled?!0:!1,f=0;f<g.length;f++)if(g[f].getTime?h=g[f].x.getTime():h=g[f].x,!(h<a.axisX.dataInfo.viewPortMin||h>a.axisX.dataInfo.viewPortMax)&&!s(g[f].y)&&g[f].y.length&&"number"===typeof g[f].y[0]&&"number"===typeof g[f].y[1]){b=a.axisX.convertValueToPixel(h);l=a.axisY.convertValueToPixel(g[f].y[0]);v=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+n)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+
n)*k<<0,w=a.axisX.reversed?m-k<<0:m+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>v){var t=l;l=v;v=t}t=q.dataPointIds[f];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:m,y1:l,x2:w,y2:v};ca(c,m,l,w,v,b,0,b,r,r,!1,!1,q.fillOpacity);b=P(t);u&&ca(this._eventManager.ghostCtx,m,l,w,v,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",
dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(w-m)/2,y:g[f].y[1]>=g[f].y[0]?v:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:m,y1:Math.min(l,v),x2:w,y2:Math.max(l,v)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:1,point:{x:m+(w-m)/2,y:g[f].y[1]>=g[f].y[0]?l:v},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:m,y1:Math.min(l,v),x2:w,y2:Math.max(l,v)},color:b})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation=
...
function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d,b=a.axisY._position?"left"===a.axisY._position||"right"===a.axisY._position?!1:!0:!1;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=!1,l=this.plotArea,v=0,h,k,n,p,q,g,r,m=a.axisX.dataInfo.minDiff;isFinite(m)||(m=0.3*Math.abs(a.axisX.range));c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(l.x1,
l.y1,l.width,l.height),this._eventManager.ghostCtx.clip());for(var w=0,t=0;t<this.data.length;t++)!this.data[t].type.match(/(bar|column)/ig)||!this.data[t].visible||this.data[t].type.match(/(stacked)/ig)&&w||w++;for(var x=0;x<a.dataSeriesIndexes.length;x++){var E=a.dataSeriesIndexes[x],B=this.data[E],C=B.dataPoints,z=s(B._linkedSeries)?!1:B._linkedSeries.type.match(/(bar|column)/ig)&&B._linkedSeries.visible?!0:!1,D=0;if(z)for(e=B._linkedSeries.id,t=0;t<e;t++)!this.data[t].type.match(/(bar|column)/ig)||
!this.data[t].visible||this.data[t].type.match(/(stacked)/ig)&&D||(this.data[t].type.match(/(range)/ig)&&(f=!0),D++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;v=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(z?w:1)))<<0:0.3*this.width;f&&(v=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:
b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(z?w:1)))<<0:0.03*this.width);t=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/(z?w:1))<<0;this.dataPointMaxWidth&&e>v&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,v));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&v<e)&&(v=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));t<e&&
(t=e);t>v&&(t=v);if(0<C.length)for(var F=B._colorSet,v=0;v<C.length;v++){var e=B.lineColor=B.options.color?B.options.color:F[0],Q={color:C[v].whiskerColor?C[v].whiskerColor:C[v].color?B.whiskerColor?B.whiskerColor:C[v].color:B.whiskerColor?B.whiskerColor:e,thickness:s(C[v].whiskerThickness)?B.whiskerThickness:C[v].whiskerThickness,dashType:C[v].whiskerDashType?C[v].whiskerDashType:B.whiskerDashType,length:s(C[v].whiskerLength)?s(B.options.whiskerLength)?t:B.options.whiskerLength:C[v].whiskerLength,
trimLength:s(C[v].whiskerLength)?s(B.options.whiskerLength)?50:0:0};Q.length="number"===typeof Q.length?0>=Q.length?0:Q.length>=t?t:Q.length:"string"===typeof Q.length?parseInt(Q.length)*t/100>t?t:parseInt(Q.length)*t/100>t:t;Q.thickness="number"===typeof Q.thickness?0>Q.thickness?0:Math.round(Q.thickness):2;var aa={color:C[v].stemColor?C[v].stemColor:C[v].color?B.stemColor?B.stemColor:C[v].color:B.stemColor?B.stemColor:e,thickness:C[v].stemThickness?C[v].stemThickness:B.stemThickness,dashType:C[v].stemDashType?
C[v].stemDashType:B.stemDashType};aa.thickness="number"===typeof aa.thickness?0>aa.thickness?0:Math.round(aa.thickness):2;C[v].getTime?r=C[v].x.getTime():r=C[v].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!s(C[v].y)&&C[v].y.length&&"number"===typeof C[v].y[0]&&"number"===typeof C[v].y[1]){var ja=a.axisX.convertValueToPixel(r);b?k=ja:h=ja;ja=a.axisY.convertValueToPixel(C[v].y[0]);b?n=ja:q=ja;ja=a.axisY.convertValueToPixel(C[v].y[1]);b?p=ja:g=ja;b?(q=a.axisX.reversed?k+(z?
w:1)*t/2-(z?D-1:0)*t<<0:k-(z?w:1)*t/2+(z?D-1:0)*t<<0,g=a.axisX.reversed?q-t<<0:q+t<<0):(n=a.axisX.reversed?h+(z?w:1)*t/2-(z?D-1:0)*t<<0:h-(z?w:1)*t/2+(z?D-1:0)*t<<0,p=a.axisX.reversed?n-t<<0:n+t<<0);!b&&q>g&&(ja=q,q=g,g=ja);b&&n>p&&(ja=n,n=p,p=ja);ja=B.dataPointIds[v];this._eventManager.objectMap[ja]={id:ja,objectType:"dataPoint",dataSeriesIndex:E,dataPointIndex:v,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:aa,whiskerProperties:Q};y(c,Math.min(n,
p),Math.min(q,g),Math.max(p,n),Math.max(g,q),e,Q,aa,b);u&&y(this._eventManager.ghostCtx,n,q,p,g,e,Q,aa,b);if(C[v].indexLabel||B.indexLabel||C[v].indexLabelFormatter||B.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:C[v],dataSeries:B,indexKeyword:0,point:{x:b?C[v].y[1]>=C[v].y[0]?n:p:n+(p-n)/2,y:b?q+(g-q)/2:C[v].y[1]>=C[v].y[0]?g:q},direction:C[v].y[1]>=C[v].y[0]?-1:1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),
this._indexLabels.push({chartType:"error",dataPoint:C[v],dataSeries:B,indexKeyword:1,point:{x:b?C[v].y[1]>=C[v].y[0]?p:n:n+(p-n)/2,y:b?q+(g-q)/2:C[v].y[1]>=C[v].y[0]?q:g},direction:C[v].y[1]>=C[v].y[0]?1:-1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:
...
(e.height*(a.axisX.logarithmic?Math.log(n)/Math.log(a.axisX.range):Math.abs(n)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>l&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<f)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));n<f&&(n=f);n>l&&(n=l);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),
...
v=a.axisY.convertValueToPixel(r[f].y[1]);h=a.axisX.convertValueToPixel(k);h=a.axisX.reversed?h+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+p)*n<<0:h-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var w=a.axisX.reversed?h-n<<0:h+n<<0;l>v&&(b=l,l=v,v=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ca(c,l,h,v,w,b,0,null,m,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,
x1:l,y1:h,x2:v,y2:w};b=P(b);u&&ca(this._eventManager.ghostCtx,l,h,v,w,b,0,null,!1,!1,!1,!1);if(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:0,point:{x:r[f].y[1]>=r[f].y[0]?l:v,y:h+(w-h)/2},direction:r[f].y[1]>=r[f].y[0]?-1:1,bounds:{x1:Math.min(l,v),y1:h,x2:Math.max(l,v),y2:w},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:1,point:{x:r[f].y[1]>=
r[f].y[0]?v:l,y:h+(w-h)/2},direction:r[f].y[1]>=r[f].y[0]?1:-1,bounds:{x1:Math.min(l,v),y1:h,x2:Math.max(l,v),y2:w},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,
e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeArea=function(a){function d(){if(x){for(var a=null,c=m.length-1;0<=c;c--)a=m[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<n.lineThickness){b.beginPath();b.moveTo(a.x,a.y2);for(c=0;c<m.length;c++)a=m[c],
b.lineTo(a.x,a.y2);b.moveTo(m[0].x,m[0].y1);for(c=0;c<m.length;c++)a=m[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(r,s);e.beginPath();e.moveTo(r,s);x={x:r,y:s};m=[];m.push({x:r,y1:s,y2:w})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();u&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();u&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());
for(var h=0;h<a.dataSeriesIndexes.length;h++){var m=[],k=a.dataSeriesIndexes[h],n=this.data[k],p=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=P(f);e.fillStyle=f;var f=[],q=!0,g=0,r,s,w,t,x=null;if(0<p.length){var E=n._colorSet[g%n._colorSet.length],B=n.lineColor=n.options.lineColor||E,C=B;b.fillStyle=E;b.strokeStyle=B;b.lineWidth=n.lineThickness;var z="solid";if(b.setLineDash){var y=N(n.nullDataLineDashType,n.lineThickness),z=n.lineDashType,D=N(z,
n.lineThickness);b.setLineDash(D)}for(var Q=!0;g<p.length;g++)if(t=p[g].x.getTime?p[g].x.getTime():p[g].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!Q)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(t);s=a.axisY.convertValueToPixel(p[g].y[0]);w=a.axisY.convertValueToPixel(p[g].y[1]);q||Q?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||z===n.lineDashType&&
n.lineDashType!==n.nullDataLineDashType)&&(m[m.length-1].newLineDashArray=D,z=n.nullDataLineDashType,b.setLineDash(y)),b.lineTo(r,s),u&&e.lineTo(r,s),m.push({x:r,y1:s,y2:w})):(b.beginPath(),b.moveTo(r,s),x={x:r,y:s},m=[],m.push({x:r,y1:s,y2:w}),u&&(e.beginPath(),e.moveTo(r,s))),Q=q=!1):(b.lineTo(r,s),m.push({x:r,y1:s,y2:w}),u&&e.lineTo(r,s),0==g%250&&d());t=n.dataPointIds[g];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:s,y2:w};g<p.length-
1&&(C!==(p[g].lineColor||B)||z!==(p[g].lineDashType||n.lineDashType))&&(d(),C=p[g].lineColor||B,m[m.length-1].newStrokeStyle=C,b.strokeStyle=C,b.setLineDash&&(p[g].lineDashType?(z=p[g].lineDashType,m[m.length-1].newLineDashArray=N(z,n.lineThickness),b.setLineDash(m[m.length-1].newLineDashArray)):(z=n.lineDashType,m[m.length-1].newLineDashArray=D,b.setLineDash(D))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(g,r,w,b);f.push(aa);var F=P(t);u&&f.push({x:r,
y:w,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness});aa=n.getMarkerProperties(g,r,s,b);f.push(aa);F=P(t);u&&f.push({x:r,y:s,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:0,point:{x:r,y:s},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:E}),
this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:1,point:{x:r,y:w},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?1:-1,color:E})}else Q||q||d(),Q=!0;d();V.drawMarkers(f)}}u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
b.beginPath(),b.moveTo(d[f].x,d[f].y),d[f].newStrokeStyle&&(b.strokeStyle=d[f].newStrokeStyle),d[f].newLineDashArray&&b.setLineDash(d[f].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}}b.beginPath();b.moveTo(d[0].x,d[0].y);u&&(e.beginPath(),e.moveTo(d[0].x,d[0].y));for(f=0;f<d.length-3;f+=3)b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y),u&&e.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y);d=w(y,2);b.lineTo(y[y.length-
1].x,y[y.length-1].y);for(f=d.length-1;2<f;f-=3)b.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y),u&&e.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y);b.closePath();b.globalAlpha=k.fillOpacity;b.fill();u&&(e.closePath(),e.fill());b.globalAlpha=1;if(0<k.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var g=f=0;f<d.length-3;f+=3,g++){if(s[g].newStrokeStyle||s[g].newLineDashArray)b.stroke(),b.beginPath(),
...
1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}b.stroke()}b.beginPath()}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();u&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();u&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var h=0;h<a.dataSeriesIndexes.length;h++){var m=a.dataSeriesIndexes[h],k=this.data[m],n=k.dataPoints,f=k.id;this._eventManager.objectMap[f]=
{objectType:"dataSeries",dataSeriesIndex:m};f=P(f);e.fillStyle=f;var f=[],p=0,q,g,r,s=[],y=[];if(0<n.length){var t=k._colorSet[p%k._colorSet.length],x=k.lineColor=k.options.lineColor||t,E=x;b.fillStyle=t;b.lineWidth=k.lineThickness;var B="solid",C;if(b.setLineDash){var z=N(k.nullDataLineDashType,k.lineThickness),B=k.lineDashType;C=N(B,k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||
!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);r=a.axisY.convertValueToPixel(n[p].y[1]);var D=k.dataPointIds[p];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:p,x1:q,y1:g,y2:r};s[s.length]={x:q,y:g};y[y.length]={x:q,y:r};p<n.length-1&&(E!==(n[p].lineColor||x)||B!==(n[p].lineDashType||k.lineDashType))&&(E=n[p].lineColor||x,s[s.length-
1].newStrokeStyle=E,b.setLineDash&&(n[p].lineDashType?(B=n[p].lineDashType,s[s.length-1].newLineDashArray=N(B,k.lineThickness)):(B=k.lineDashType,s[s.length-1].newLineDashArray=C)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<k.markerSize)){var F=k.getMarkerProperties(p,q,g,b);f.push(F);var Q=P(D);u&&f.push({x:q,y:g,ctx:e,type:F.type,size:F.size,color:Q,borderColor:Q,borderThickness:F.borderThickness});F=k.getMarkerProperties(p,q,r,b);f.push(F);Q=P(D);u&&f.push({x:q,y:r,ctx:e,type:F.type,size:F.size,
color:Q,borderColor:Q,borderThickness:F.borderThickness})}if(n[p].indexLabel||k.indexLabel||n[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:n[p].y[0]<=n[p].y[1]?-1:1,color:t}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:1,point:{x:q,y:r},direction:n[p].y[0]<=n[p].y[1]?1:-1,color:t});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&
(0<s.length&&(k.options.nullDataLineDashType||!n[p-1].lineDashType))&&(s[s.length-1].newLineDashArray=z,B=k.nullDataLineDashType):(d(C,x),s=[],y=[])),g=!0;d(C,x);V.drawMarkers(f)}}u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};m.prototype.renderWaterfall=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,e=null,f=this.plotArea,l=0,h,m,k,n,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
Math.abs(q)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&l>m&&(l=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<l)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,l));q<l&&(q=l);q>m&&(q=m);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(f.x1,
f.y1,f.width,f.height),this._eventManager.ghostCtx.clip());for(var g=0;g<a.dataSeriesIndexes.length;g++){var r=a.dataSeriesIndexes[g],s=this.data[r],w=s.dataPoints,e=s._colorSet[0];s.risingColor=s.options.risingColor?s.options.risingColor:e;s.fallingColor=s.options.fallingColor?s.options.fallingColor:"#e40a0a";var t="number"===typeof s.options.lineThickness?Math.round(s.lineThickness):1,x=1===Math.round(t)%2?-0.5:0;if(0<w.length)for(var E=5<q&&s.bevelEnabled?!0:!1,B=!1,y=null,z=null,l=0;l<w.length;l++)if(w[l].getTime?
n=w[l].x.getTime():n=w[l].x,"number"!==typeof w[l].y){if(0<l&&!B&&s.connectNullData)var D=s.options.nullDataLineDashType||!w[l-1].lineDashType?s.nullDataLineDashType:w[l-1].lineDashType;B=!0}else{h=a.axisX.convertValueToPixel(n);m=0===s.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);k=0===s.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);h=a.axisX.reversed?h+a.plotType.totalDataSeries*
q/2-(a.previousDataSeriesCount+g)*q<<0:h-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+g)*q<<0;var F=a.axisX.reversed?h-q<<0:h+q<<0;m>k&&(e=m,m=k,k=e);a.axisY.reversed&&(e=m,m=k,k=e);e=s.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:l,x1:h,y1:m,x2:F,y2:k};var Q=w[l].color?w[l].color:0<w[l].y?s.risingColor:s.fallingColor;ca(c,h,m,F,k,Q,0,Q,E,E,!1,!1,s.fillOpacity);e=P(e);u&&ca(this._eventManager.ghostCtx,h,m,F,k,e,0,null,!1,
!1,!1,!1);var aa,Q=h;aa="undefined"!==typeof w[l].isIntermediateSum&&!0===w[l].isIntermediateSum||"undefined"!==typeof w[l].isCumulativeSum&&!0===w[l].isCumulativeSum?0<w[l].y?m:k:0<w[l].y?k:m;0<l&&y&&(!B||s.connectNullData)&&(B&&c.setLineDash&&c.setLineDash(N(D,t)),c.beginPath(),c.moveTo(y,z-x),c.lineTo(Q,aa-x),0<t&&c.stroke(),u&&(b.beginPath(),b.moveTo(y,z-x),b.lineTo(Q,aa-x),0<t&&b.stroke()));B=!1;y=F;z=0<w[l].y?m:k;Q=w[l].lineDashType?w[l].lineDashType:s.options.lineDashType?s.options.lineDashType:
"shortDash";c.strokeStyle=w[l].lineColor?w[l].lineColor:s.options.lineColor?s.options.lineColor:"#9e9e9e";c.lineWidth=t;c.setLineDash&&(Q=N(Q,t),c.setLineDash(Q));(w[l].indexLabel||s.indexLabel||w[l].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:w[l],dataSeries:s,point:{x:h+(F-h)/2,y:0<=w[l].y?m:k},direction:0>w[l].y===a.axisY.reversed?1:-1,bounds:{x1:h,y1:Math.min(m,k),x2:F,y2:Math.max(m,k)},color:e})}}u&&(d.drawImage(this._preRenderCanvas,0,
...
animationBase:0}}};var W=function(a,d,c,b,e,f,l,h,m){if(!(0>c)){"undefined"===typeof h&&(h=1);if(!u){var k=Number((l%(2*Math.PI)).toFixed(8));Number((f%(2*Math.PI)).toFixed(8))===k&&(l-=1E-4)}a.save();a.globalAlpha=h;"pie"===e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,c,f,l,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.closePath(),a.fill()):"doughnut"===e&&(a.beginPath(),a.arc(d.x,d.y,c,f,l,!1),0<=m&&a.arc(d.x,d.y,m*c,l,f,!0),a.closePath(),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=
...
f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,k,e):k.indexLabelFormatter?k.indexLabelFormatter(v):k.indexLabel?m.replaceKeywordsWithValue(k.indexLabel,f,k,e):f.label?f.label:"";m._eventManager.objectMap[l]=p;p.center={x:E.x,y:E.y};p.y=f.y;p.radius=z;p.percentInnerRadius=F;p.indexLabelText=h;p.indexLabelPlacement=k.indexLabelPlacement;p.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:k.options.indexLabelLineColor?k.options.indexLabelLineColor:f.color?f.color:k._colorSet[e%
...
f.indexLabelWrap:k.indexLabelWrap;p.indexLabelTextAlign=f.indexLabelTextAlign?f.indexLabelTextAlign:k.indexLabelTextAlign?k.indexLabelTextAlign:"left";p.startAngle=0===e?k.startAngle?k.startAngle/180*Math.PI:0:g[e-1].endAngle;p.startAngle=(p.startAngle+2*Math.PI)%(2*Math.PI);p.endAngle=p.startAngle+2*Math.PI/B*Math.abs(f.y);f=(p.endAngle+p.startAngle)/2;f=(f+2*Math.PI)%(2*Math.PI);p.midAngle=f;if(p.midAngle>Math.PI/2-t&&p.midAngle<Math.PI/2+t){if(0===a||g[c].midAngle>p.midAngle)c=e;a++}else if(p.midAngle>
3*Math.PI/2-t&&p.midAngle<3*Math.PI/2+t){if(0===b||g[d].midAngle>p.midAngle)d=e;b++}p.hemisphere=f>Math.PI/2&&f<=3*Math.PI/2?"left":"right";p.indexLabelTextBlock=new ia(m.plotArea.ctx,{fontSize:p.indexLabelFontSize,fontFamily:p.indexLabelFontFamily,fontColor:p.indexLabelFontColor,fontStyle:p.indexLabelFontStyle,fontWeight:p.indexLabelFontWeight,textAlign:p.indexLabelTextAlign,backgroundColor:p.indexLabelBackgroundColor,maxWidth:p.indexLabelMaxWidth,maxHeight:p.indexLabelWrap?5*p.indexLabelFontSize:
...
q.y1,q.width,q.height);b.fillStyle=m.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);for(b=0;b<n.length;b++){var c=g[b].startAngle,d=g[b].endAngle;if(d>c){var e=0.07*z*Math.cos(g[b].midAngle),f=0.07*z*Math.sin(g[b].midAngle),l=!1;if(n[b].exploded){if(1E-9<Math.abs(g[b].center.x-(E.x+e))||1E-9<Math.abs(g[b].center.y-(E.y+f)))g[b].center.x=E.x+e*a,g[b].center.y=E.y+f*a,l=!0}else if(0<Math.abs(g[b].center.x-E.x)||0<Math.abs(g[b].center.y-E.y))g[b].center.x=E.x+e*(1-a),g[b].center.y=E.y+f*(1-a),
...
l=E.y-1*u,p=E.y+1*u;if(0<=a&&a<n.length){var h=g[a];if(0>c&&h.indexLabelTextBlock.y<l||0<c&&h.indexLabelTextBlock.y>p)return 0;var q=0,m=0,m=q=q=0;0>c?h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2>l&&h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2+c<l&&(c=-(l-(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2+c))):h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2<l&&h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+c>p&&(c=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/
2+c-p);c=h.indexLabelTextBlock.y+c;l=0;l="right"===h.hemisphere?E.x+Math.sqrt(Math.pow(u,2)-Math.pow(c-E.y,2)):E.x-Math.sqrt(Math.pow(u,2)-Math.pow(c-E.y,2));m=E.x+z*Math.cos(h.midAngle);q=E.y+z*Math.sin(h.midAngle);q=Math.sqrt(Math.pow(l-m,2)+Math.pow(c-q,2));m=Math.acos(z/u);q=Math.acos((u*u+z*z-q*q)/(2*z*u));c=q<m?c-h.indexLabelTextBlock.y:0;l=null;for(p=1;p<n.length;p++)if(l=(a-p+g.length)%g.length,g[l].hemisphere!==g[a].hemisphere){l=null;break}else if(g[l].indexLabelText&&g[l].hemisphere===
g[a].hemisphere&&l!==a&&(0>b(g[l],g[a])||("right"===g[a].hemisphere?g[l].indexLabelTextBlock.y<=g[a].indexLabelTextBlock.y:g[l].indexLabelTextBlock.y>=g[a].indexLabelTextBlock.y)))break;else l=null;m=l;q=e(a);p=l=0;0>c?(p="right"===h.hemisphere?m:q,k=c,null!==p&&(m=-c,c=h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-(g[p].indexLabelTextBlock.y+g[p].indexLabelTextBlock.height/2),c-m<r&&(l=-m,p=f(p,l,d+1),+p.toFixed(x)>+l.toFixed(x)&&(k=c>r?-(c-r):-(m-(p-l)))))):0<c&&(p="right"===h.hemisphere?
q:m,k=c,null!==p&&(m=c,c=g[p].indexLabelTextBlock.y-g[p].indexLabelTextBlock.height/2-(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2),c-m<r&&(l=m,p=f(p,l,d+1),+p.toFixed(x)<+l.toFixed(x)&&(k=c>r?c-r:m-(l-p)))));k&&(d=h.indexLabelTextBlock.y+k,c=0,c="right"===h.hemisphere?E.x+Math.sqrt(Math.pow(u,2)-Math.pow(d-E.y,2)):E.x-Math.sqrt(Math.pow(u,2)-Math.pow(d-E.y,2)),h.midAngle>Math.PI/2-t&&h.midAngle<Math.PI/2+t?(l=(a-1+g.length)%g.length,l=g[l],a=g[(a+1+g.length)%g.length],"left"===h.hemisphere&&
...
15)),h.indexLabelTextBlock.y=d,h.indexLabelTextBlock.x=c,h.indexLabelAngle=Math.atan2(h.indexLabelTextBlock.y-E.y,h.indexLabelTextBlock.x-E.x))}return k}function l(){var a=m.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var c=a=0,d=0,l=!0,c=0;10>c&&(1>c||0<d);c++){if(k.radius||!k.radius&&"undefined"!==typeof k.innerRadius&&null!==k.innerRadius&&z-d<=D)l=!1;l&&(z-=d);d=0;if("inside"!==k.indexLabelPlacement){u=z*w;for(a=0;a<n.length;a++){var h=
g[a];h.indexLabelTextBlock.x=E.x+u*Math.cos(h.midAngle);h.indexLabelTextBlock.y=E.y+u*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=z;h.percentInnerRadius=F}for(var v,s,a=0;a<n.length;a++){var h=g[a],t=e(a);if(null!==t){v=g[a];s=g[t];var B=0,B=b(v,s)-r;if(0>B){for(var y=s=0,C=0;C<n.length;C++)C!==a&&g[C].hemisphere===h.hemisphere&&(g[C].indexLabelTextBlock.y<h.indexLabelTextBlock.y?s++:y++);s=B/(s+y||1)*y;var y=-1*(B-s),J=C=0;"right"===h.hemisphere?(C=f(a,s),y=-1*(B-C),J=f(t,y),+J.toFixed(x)<
+y.toFixed(x)&&+C.toFixed(x)<=+s.toFixed(x)&&f(a,-(y-J))):(C=f(t,s),y=-1*(B-C),J=f(a,y),+J.toFixed(x)<+y.toFixed(x)&&+C.toFixed(x)<=+s.toFixed(x)&&f(t,-(y-J)))}}}}else for(a=0;a<n.length;a++)h=g[a],u="pie"===k.type?0.7*z:0.8*z,t=E.x+u*Math.cos(h.midAngle),s=E.y+u*Math.sin(h.midAngle),h.indexLabelTextBlock.x=t,h.indexLabelTextBlock.y=s;for(a=0;a<n.length;a++)if(h=g[a],t=h.indexLabelTextBlock.measureText(),0!==t.height&&0!==t.width)t=t=0,"right"===h.hemisphere?(t=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+
...
function(a){function d(){for(var a=0,b=[],c=0;c<x.length;c++){if("undefined"===typeof x[c].y)return-1;x[c].y="number"===typeof x[c].y?x[c].y:0;a+=Math.abs(x[c].y)}if(0===a)return-1;for(c=b[0]=0;c<x.length;c++)b.push(Math.abs(x[c].y)*D/a);return b}function c(){var a=X,b=Z,c=L,d=V,e,f;e=Y;f=P-ba;d=Math.abs((f-e)*(b-a+(d-c))/2);c=V-L;e=f-e;f=c*(f-P);f=Math.abs(f);f=d+f;for(var d=[],g=0,k=0;k<x.length;k++){if("undefined"===typeof x[k].y)return-1;x[k].y="number"===typeof x[k].y?x[k].y:0;g+=Math.abs(x[k].y)}if(0===
g)return-1;for(var l=d[0]=0,n=0,h,p,b=b-a,l=!1,k=0;k<x.length;k++)a=Math.abs(x[k].y)*f/g,l?h=0==Number(c.toFixed(3))?0:a/c:(p=$*$*b*b-4*Math.abs($)*a,0>p?(p=c,l=(b+p)*(e-n)/2,a-=l,h=e-n,n+=e-n,h+=0==p?0:a/p,n+=a/p,l=!0):(h=(Math.abs($)*b-Math.sqrt(p))/2,p=b-2*h/Math.abs($),n+=h,n>e&&(n-=h,p=c,l=(b+p)*(e-n)/2,a-=l,h=e-n,n+=e-n,h+=a/p,n+=a/p,l=!0),b=p)),d.push(h);return d}function b(){if(t&&x){for(var a,b,c,d,e,f,k,l,n,h,p,q,m,v,r,A=[],w=[],E={percent:null,total:null},B=null,z=0;z<x.length;z++)r=O[z],
r="undefined"!==typeof r.x5?(r.y2+r.y4)/2:(r.y2+r.y3)/2,r=g(r).x2+1,A[z]=M-r-U;r=0.5*U;for(var z=0,C=x.length-1;z<x.length||0<=C;z++,C--){b=t.reversed?x[C]:x[z];a=b.color?b.color:t.reversed?t._colorSet[(x.length-1-z)%t._colorSet.length]:t._colorSet[z%t._colorSet.length];c=b.indexLabelPlacement||t.indexLabelPlacement||"outside";v=b.indexLabelTextAlign||t.indexLabelTextAlign||"left";d=b.indexLabelBackgroundColor||t.indexLabelBackgroundColor||(u?"transparent":null);e=b.indexLabelFontColor||t.indexLabelFontColor||
"#979797";f=s(b.indexLabelFontSize)?t.indexLabelFontSize:b.indexLabelFontSize;k=b.indexLabelFontStyle||t.indexLabelFontStyle||"normal";l=b.indexLabelFontFamily||t.indexLabelFontFamily||"arial";n=b.indexLabelFontWeight||t.indexLabelFontWeight||"normal";a=b.indexLabelLineColor||t.options.indexLabelLineColor||a;h="number"===typeof b.indexLabelLineThickness?b.indexLabelLineThickness:"number"===typeof t.indexLabelLineThickness?t.indexLabelLineThickness:2;p=b.indexLabelLineDashType||t.indexLabelLineDashType||
"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof t.indexLabelWrap?t.indexLabelWrap:!0;m=t.dataPointIds[z];y._eventManager.objectMap[m]={id:m,objectType:"dataPoint",dataPointIndex:z,dataSeriesIndex:0,funnelSection:O[t.reversed?x.length-1-z:z]};"inside"===t.indexLabelPlacement&&(A[z]=z!==ca?t.reversed?O[z].x2-O[z].x1:O[z].x3-O[z].x4:O[z].x3-O[z].x6,20>A[z]&&(A[z]=z!==ca?t.reversed?O[z].x3-O[z].x4:O[z].x2-O[z].x1:O[z].x2-O[z].x1,A[z]/=2));m=b.indexLabelMaxWidth?b.indexLabelMaxWidth:
t.options.indexLabelMaxWidth?t.indexLabelMaxWidth:A[z];if(m>A[z]||0>m)m=A[z];w[z]="inside"===t.indexLabelPlacement?O[z].height:!1;E=y.getPercentAndTotal(t,b);if(t.indexLabelFormatter||b.indexLabelFormatter)B={chart:y.options,dataSeries:t,dataPoint:b,total:E.total,percent:E.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(B):b.indexLabel?y.replaceKeywordsWithValue(b.indexLabel,b,t,z):t.indexLabelFormatter?t.indexLabelFormatter(B):t.indexLabel?y.replaceKeywordsWithValue(t.indexLabel,b,t,z):b.label?
b.label:"";0>=h&&(h=0);1E3>m&&1E3-m<r&&(m+=1E3-m);R.roundRect||Ba(R);c=new ia(R,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:n,horizontalAlign:c,textAlign:v,backgroundColor:d,maxWidth:m,maxHeight:!1===w[z]?q?4.28571429*f:1.5*f:w[z],text:b,padding:da});c.measureText();I.push({textBlock:c,id:t.reversed?C:z,isDirty:!1,lineColor:a,lineThickness:h,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=
[];e=!1;c=0;for(var g,k=M-Z-U/2,k=t.options.indexLabelMaxWidth?t.indexLabelMaxWidth>k?k:t.indexLabelMaxWidth:k,l=I.length-1;0<=l;l--){g=x[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<O.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+da>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=O[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=M-k,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:
I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,t.reversed?(I[l].textBlock.y+I[l].height>na+B&&(I[l].textBlock.y=na+B-I[l].height),I[l].textBlock.y<sa-B&&(I[l].textBlock.y=sa-B)):(I[l].textBlock.y<na-B&&(I[l].textBlock.y=na-B),I[l].textBlock.y+I[l].height>sa+B&&(I[l].textBlock.y=sa+B-I[l].height))}function f(){var a,
...
e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<O.length?I[b].textBlock.y:t.reversed?na+B:sa+B)-(0>a?t.reversed?sa-B:na-B:I[a].textBlock.y+I[a].height+da)}function m(a,b,c){var d,e,g,l=[],h=B,p=[];-1!==b&&(0<=W.indexOf(b)?(e=W.indexOf(b),W.splice(e,1)):(W.push(b),W=W.sort(function(a,b){return a-b})));if(0===W.length)l=ga;else{e=B*(1!=W.length||0!=W[0]&&W[0]!=O.length-1?2:1)/k();for(var q=0;q<O.length;q++){if(1==W.length&&0==W[0]){if(0===q){l.push(ga[q]);d=h;continue}}else 0===
q&&(d=-1*h);l.push(ga[q]+d);if(0<=W.indexOf(q)||q<O.length&&0<=W.indexOf(q+1))d+=e}}g=function(){for(var a=[],b=0;b<O.length;b++)a.push(l[b]-O[b].y1);return a}();var v={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return K.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<O.length;d++)b=g[d],c=O[d],b*=a,"undefined"===typeof p[d]&&(p[d]=0),0>p&&(p*=-1),c.y1+=b-p[d],c.y2+=b-p[d],c.y3+=b-p[d],c.y4+=b-p[d],c.y5&&(c.y5+=b-p[d],c.y6+=b-p[d]),p[d]=
b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ha=!0;d.clearRect(E.x1,E.y1,E.x2-E.x1,E.y2-E.y1);d.fillStyle=a.backgroundColor;d.fillRect(E.x1,E.y1,E.width,E.height);v.changeSection(c,b);var e={};e.dataSeries=t;e.dataPoint=t.reversed?t.dataPoints[x.length-1-b]:t.dataPoints[b];e.index=t.reversed?x.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<O.length;e++)pa(d,O[e],t.fillOpacity);w(d);J&&("inside"!==t.indexLabelPlacement?n(d):f(),r(d));1<=c&&(ha=!1)},null,K.easing.easeOutQuart)}
...
S.fNg&&S.fNg(y)}var y=this;if(!(0>=a.dataSeriesIndexes.length)){for(var t=this.data[a.dataSeriesIndexes[0]],x=t.dataPoints,E=this.plotArea,B=0.025*E.width,C=0.01*E.width,z=0,D=E.height-2*B,F=Math.min(E.width-2*C,2.8*E.height),J=!1,H=0;H<x.length;H++)if(!J&&("undefined"!==typeof x[H].indexLabel&&null!==x[H].indexLabel&&0<x[H].indexLabel.toString().length)&&(J=!0),!J&&("undefined"!==typeof x[H].label&&null!==x[H].label&&0<x[H].label.toString().length)&&(J=!0),!J&&"function"===typeof t.indexLabelFormatter||
"function"===typeof x[H].indexLabelFormatter)J=!0;J=J||"undefined"!==typeof t.indexLabel&&null!==t.indexLabel&&0<t.indexLabel.toString().length;"inside"!==t.indexLabelPlacement&&J||(C=(E.width-0.75*F)/2);var H=E.x1+C,M=E.x2-C,Y=E.y1+B,P=E.y2-B,R=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=t.length&&(t.dataPoints&&t.visible)&&0!==x.length){var ba,G;a=75*F/100;var U=30*(M-a)/100;"funnel"===t.type?(ba=s(t.options.neckHeight)?0.35*D:t.neckHeight,G=s(t.options.neckWidth)?0.25*a:t.neckWidth,"string"===
typeof ba&&ba.match(/%$/)?(ba=parseInt(ba),ba=ba*D/100):ba=parseInt(ba),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),ba>D?ba=D:0>=ba&&(ba=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===t.type&&(G=ba=0,t.reversed=t.reversed?!1:!0);var C=H+a/2,X=H,Z=H+a,na=t.reversed?P:Y,L=C-G/2,V=C+G/2,xa=t.reversed?Y+ba:P-ba,sa=t.reversed?Y:P;a=[];var C=[],O=[],F=[],T=Y,ca,$=(xa-na)/(L-X),ea=-$,H="area"===(t.valueRepresents?t.valueRepresents:"height")?c():d();if(-1!==H){if(t.reversed)for(F.push(T),
G=H.length-1;0<G;G--)T+=H[G],F.push(T);else for(G=0;G<H.length;G++)T+=H[G],F.push(T);if(t.reversed)for(G=0;G<H.length;G++)F[G]<xa?(a.push(L),C.push(V),ca=G):(a.push((F[G]-na+$*X)/$),C.push((F[G]-na+ea*Z)/ea));else for(G=0;G<H.length;G++)F[G]<xa?(a.push((F[G]-na+$*X)/$),C.push((F[G]-na+ea*Z)/ea),ca=G):(a.push(L),C.push(V));for(G=0;G<H.length-1;G++)T=t.reversed?x[x.length-1-G].color?x[x.length-1-G].color:t._colorSet[(x.length-1-G)%t._colorSet.length]:x[G].color?x[G].color:t._colorSet[G%t._colorSet.length],
G===ca?O.push({x1:a[G],y1:F[G],x2:C[G],y2:F[G],x3:V,y3:xa,x4:C[G+1],y4:F[G+1],x5:a[G+1],y5:F[G+1],x6:L,y6:xa,id:G,height:F[G+1]-F[G],color:T}):O.push({x1:a[G],y1:F[G],x2:C[G],y2:F[G],x3:C[G+1],y3:F[G+1],x4:a[G+1],y4:F[G+1],id:G,height:F[G+1]-F[G],color:T});var da=2,I=[],ha=!1,W=[],ga=[],H=!1;a=a=0;Ca(W);for(G=0;G<x.length;G++)x[G].exploded&&(H=!0,t.reversed?W.push(x.length-1-G):W.push(G));R.clearRect(E.x1,E.y1,E.width,E.height);R.fillStyle=y.backgroundColor;R.fillRect(E.x1,E.y1,E.width,E.height);
if(J&&t.visible&&(b(),f(),e(),"inside"!==t.indexLabelPlacement)){l();for(G=0;G<x.length;G++)I[G].isDirty||(a=I[G].textBlock.x+I[G].width,a=(M-a)/2,0==G&&(z=a),z>a&&(z=a));for(G=0;G<O.length;G++)O[G].x1+=z,O[G].x2+=z,O[G].x3+=z,O[G].x4+=z,O[G].x5&&(O[G].x5+=z,O[G].x6+=z),I[G].textBlock.x+=z}for(G=0;G<O.length;G++)z=O[G],pa(R,z,t.fillOpacity),ga.push(z.y1);w(R);J&&t.visible&&("inside"===t.indexLabelPlacement||y.animationEnabled||n(R),y.animationEnabled||r());if(!J)for(G=0;G<x.length;G++)z=t.dataPointIds[G],
a={id:z,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:O[t.reversed?x.length-1-G:G]},y._eventManager.objectMap[z]=a;!y.animationEnabled&&H?m(y,-1,0):y.animationEnabled&&!y.animatedRender&&m(y,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ha&&!y.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=t.reversed?x.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===t.type||"pyramid"===t.type)t.reversed?x[x.length-1-a].exploded=
x[x.length-1-a].exploded?!1:!0:x[a].exploded=x[a].exploded?!1:!0;m(y,b,500)}};return{source:R,dest:this.plotArea.ctx,animationCallback:function(a,b){K.fadeInAnimation(a,b);1<=a&&(m(y,-1,500),w(y.plotArea.ctx||y.ctx))},easingFunction:K.easing.easeInQuad,animationBase:0}}}}};m.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,
...
a.length-1));a=a.replace("#index",e);var k=null;try{var g=a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);g&&0<g.length&&(k=Fa(g[2]),a=Fa(g[1]))}catch(l){}g=null;if("color"===a)return"waterfall"===c.type?d.color?d.color:0<d.y?c.risingColor:c.fallingColor:"error"===c.type?c.color?c.color:c._colorSet[k%c._colorSet.length]:d.color?d.color:c.color?c.color:c._colorSet[b%c._colorSet.length];if(d.hasOwnProperty(a))g=d;else if(c.hasOwnProperty(a))g=c;else return"";g=g[a];null!==k&&(g=g[k]);if("x"===a)if(c.axisX&&"dateTime"===
...
d.yValueFormatString:c.yValueFormatString?c.yValueFormatString:c.yValueFormatString="#,##0.########",f._cultureInfo):"z"===a?ea(g,d.zValueFormatString?d.zValueFormatString:c.zValueFormatString?c.zValueFormatString:c.zValueFormatString="#,##0.########",f._cultureInfo):g})};oa(F,U);F.prototype.setLayout=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),c=null,b=0,e=0,f=0,l=0,h=this.markerMargin=this.chart.options.legend&&!s(this.chart.options.legend.markerMargin)?
...
f=this.maxWidth=null!==this.maxWidth?this.maxWidth:0.5*d.width;l=this.maxHeight=null!==this.maxHeight?this.maxHeight:d.height}this.errorMarkerColor=[];for(var n=0;n<this.dataSeries.length;n++){var p=this.dataSeries[n];if(p.dataPoints&&p.dataPoints.length)if("pie"!==p.type&&"doughnut"!==p.type&&"funnel"!==p.type&&"pyramid"!==p.type){var q=p.legendMarkerType=p.legendMarkerType?p.legendMarkerType:"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type&&"scatter"!==p.type&&"bubble"!==p.type||!p.markerType?
...
u=p.markerSize||"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type?0.75*this.lineHeight:0,w=p.legendMarkerBorderColor?p.legendMarkerBorderColor:p.markerBorderColor,t=p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:p.markerBorderThickness?Math.max(1,Math.round(0.2*u)):0;"error"===p.type&&this.errorMarkerColor.push(r);g=this.chart.replaceKeywordsWithValue(g,p.dataPoints[0],p,n);q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:u,lineColor:p._colorSet[0],
dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:w,markerBorderThickness:t};m.push(q)}else for(var x=0;x<p.dataPoints.length;x++){var y=p.dataPoints[x],q=y.legendMarkerType?y.legendMarkerType:p.legendMarkerType?p.legendMarkerType:H.getDefaultLegendMarker(p.type),g=y.legendText?y.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:y}):y.name?y.name:"DataPoint: "+(x+1),r=y.legendMarkerColor?y.legendMarkerColor:
p.legendMarkerColor?p.legendMarkerColor:y.color?y.color:p.color?p.color:p._colorSet[x%p._colorSet.length],u=0.75*this.lineHeight,w=y.legendMarkerBorderColor?y.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:y.markerBorderColor?y.markerBorderColor:p.markerBorderColor,t=y.legendMarkerBorderThickness?y.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:y.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*u)):0,g=this.chart.replaceKeywordsWithValue(g,
y,p,x),q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:u,dataSeriesIndex:n,dataPointIndex:x,markerBorderColor:w,markerBorderThickness:t};(y.showInLegend||p.showInLegend&&!1!==y.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();if(0<m.length){p=null;r=g=y=x=0;y=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=
f;u=0===u?0.75*this.lineHeight:u;y-=u+h;for(n=0;n<m.length;n++){q=m[n];w=y;if("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType)w-=2*0.1*this.lineHeight;if(!(0>=l||"undefined"===typeof l||0>=w||"undefined"===typeof w)){if("horizontal"===this.orientation){q.textBlock=new ia(this.ctx,{x:0,y:0,maxWidth:w,maxHeight:this.itemWrap?l:this.lineHeight,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,
...
0.1*this.lineHeight;if("error"===q.chartType){this.ctx.strokeStyle=this.errorMarkerColor[0];this.ctx.lineWidth=f/8;this.ctx.beginPath();var u=g-0.08*this.lineHeight+0.1*this.lineHeight,t=r+0.15*this.lineHeight,x=0.7*this.lineHeight,w=x+0.02*this.lineHeight;this.ctx.moveTo(u,t);this.ctx.lineTo(u+x,t);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(u+x/2,t);this.ctx.lineTo(u+x/2,t+w);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(u,t+w);this.ctx.lineTo(u+x,t+w);this.ctx.stroke();this.errorMarkerColor.shift()}V.drawMarker(g+
...
q.x1&&(a<=q.x2&&d>=q.y1&&d<=q.y2)&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:Math.min(Math.abs(q.x1-a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),h=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var s=la("markerSize",g,this)||4,u=c?20:s,r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=u&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=
Math.abs(q.x1-a);q<=m?m=q:0<l?k++:n++;r<=s/2&&(h=!0);break;case "rangeArea":case "rangeSplineArea":s=la("markerSize",g,this)||4;u=c?20:s;r=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));r<=u&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=m?m=q:0<l?k++:n++;r<=s/2&&(h=!0);break;case "bubble":s=q.size;r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=s/2&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,
...
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),U+=B[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),L=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+V+W<Math.max(L,p)?Math.max(L,p):f.y1+V+W),L=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(T+e+L)),b[g].lineCoordinates=
...
(0<l?l*Math.abs(d[g].conversionParameters.pixelPerUnit):0)+d[g].lineCoordinates.x1);for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<u){if(a&&0<a.length)for(g=0;g<a.length;g++)r=M[u-1][g]===M[u][g]?!0:!1;else r=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=N[u-1][g]===N[u][g]?!0:!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=P[u-1][g]===P[u][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=R[u-
1][g]===R[u][g]?!0:!1;else K=!0}if(r&&H&&J&&K)break;u++}if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),a[g].calculateBreaksInPixels();if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateStripLinesThicknessInValues(),d[g].calculateBreaksInPixels();if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels()}else{p=
[];z=[];F=[];w=[];D=[];t=[];M=[];for(N=[];4>u;){T=X=S=U=Z=L=W=e=R=P=G=V=0;if(a&&0<a.length)for(F=[],g=X=0;g<a.length;g++)F.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),X+=F[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else F.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));M.push(F);if(d&&0<d.length)for(w=[],g=T=0;g<d.length;g++)w.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),T+=w[g],W+=d[g]?d[g].margin:0;else w.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
0));N.push(w);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+X+e),m=Math.round(f.x2-T-W>n.width-10?n.width-10:f.x2-T-W),c[g].labelAutoFit&&!s(x)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,x):0===c[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-y/2:0===c[g].labelAngle?m-y/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+X+e),m=Math.round(f.x2-T-W>b[g].chart.width-10?b[g].chart.width-10:f.x2-T-W),b[g]&&b[g].labelAutoFit&&!s(B)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,B):0===b[g].labelAngle?Math.max(l,B/2):l),0<!d.length&&(m-=C/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(p=[],g=U=0;g<c.length;g++)p.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateHeight():0)),U+=p[g]+c[g].margin,L+=c[g].margin;else p.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));D.push(p);if(b&&0<b.length)for(z=[],g=S=0;g<b.length;g++)z.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateHeight():0)),S+=z[g],Z+=b[g].margin;else z.push(Math.ceil(b[0]?
...
0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.height?d[g].titleMaxWidth:d[g].lineCoordinates.height);d[g].calculateValueToPixelConversionParameters();d[g].calculateBreaksSizeInValues();R+=w[g]+d[g].margin}for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<u){if(a&&0<a.length)for(g=0;g<a.length;g++)r=M[u-1][g]===M[u][g]?!0:!1;else r=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=N[u-1][g]===N[u][g]?!0:
!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=D[u-1][g]===D[u][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=t[u-1][g]===t[u][g]?!0:!1;else K=!0}if(r&&H&&J&&K)break;u++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),
...
1===a.lineWidth%2?(d.y<<0)+0.5:d.y<<0,a.moveTo(c.x1<<0,d),a.lineTo(c.x2<<0,d),a.stroke());a.restore()}};D.prototype.renderAxisLine=function(){var a=this.chart.ctx,d=u?this.chart._preRenderCtx:a,c=Math.ceil(this.tickThickness/(this.reversed?-2:2)),b=Math.ceil(this.tickThickness/(this.reversed?2:-2)),e,f;d.save();if("bottom"===this._position||"top"===this._position){if(this.lineThickness){this.reversed?(e=this.lineCoordinates.x2,f=this.lineCoordinates.x1):(e=this.lineCoordinates.x1,f=this.lineCoordinates.x2);
...
"error"===n[0].dataSeries.type)for(var u=Math.abs(a-this.parent.convertValueToPixel(n[w].dataPoint.y[0])),t=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(var x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<u&&(u=t,w=r);else t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),t<u&&(u=t,w=r);else if("stackedBar"===n[0].dataSeries.type)for(var u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),y=t=
0,r=w=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<u&&(u=t,w=r);else y+=n[r].dataPoint.y,t=Math.abs(a-this.parent.convertValueToPixel(y)),t<u&&(u=t,w=r);else if("stackedBar100"===n[0].dataSeries.type)for(var u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),B=y=t=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=
Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<u&&(u=t,w=r);else y+=n[r].dataPoint.y,B=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,B=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[B]),t=Math.abs(a-this.parent.convertValueToPixel(B)),t<u&&(u=t,w=r);else for(u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=w=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),
t<u&&(u=t,w=r);else t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),t<u&&(u=t,w=r);x=n[w];if("bottom"===this.parent._position||"top"===this.parent._position){b=0;if("rangeBar"===this.parent.dataSeries[w].type||"error"===this.parent.dataSeries[w].type){u=Math.abs(a-this.parent.convertValueToPixel(x.dataPoint.y[0]));for(r=t=0;r<x.dataPoint.y.length;r++)t=Math.abs(a-this.parent.convertValueToPixel(x.dataPoint.y[r])),t<u&&(u=t,b=r);h=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y[b])<<
0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y[b])<<0;this.value=x.dataPoint.y[b];k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y[b]}):s(this.options.label)?ea(c?c:x.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar"===this.parent.dataSeries[w].type){u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,t=Math.abs(a-
this.parent.convertValueToPixel(y)),t<u&&(u=t,b=r);h=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;this.value=y;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):s(this.options.label)?ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[w].type){u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));
B=y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,B=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,B=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[B]),t=Math.abs(a-this.parent.convertValueToPixel(B)),t<u&&(u=t,b=r);h=1===q.lineWidth%2?(this.parent.convertValueToPixel(B)<<0)+0.5:this.parent.convertValueToPixel(B)<<0;this.value=B;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:B}):s(this.options.label)?ea(c?
...
l=m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-p/2,x2:e,y2:l+p/2};B=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])B=!0;else{B=!1;break}if(B){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),u=null,w=0;w<this.parent.dataSeries.length;w++)(u=
...
this.chart.bounds.y2-k.measureText().height+k.fontSize/2);"left"===this.parent._position?k.x=this.parent.lineCoordinates.x2-k.measureText().width:"right"===this.parent._position&&(k.x=this.parent.lineCoordinates.x2)}}else if("bottom"===this.parent._position||"top"===this.parent._position){r=this.parent.convertPixelToValue({x:a});for(w=0;w<this.parent.dataSeries.length;w++)(u=this.parent.dataSeries[w].getDataPointAtX(r,!0))&&0<=u.index&&(u.dataSeries=this.parent.dataSeries[w],null!==u.dataPoint.y&&
u.dataSeries.visible&&n.push(u));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});x=n[0];b=e=h=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;f=this.chart.plotArea.y1;l=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:l};B=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])B=!0;else{B=!1;break}if(B){if("axisX"===
...
k.width);k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);"bottom"===this.parent._position?k.y=this.parent.lineCoordinates.y2+k.fontSize/2+2:"top"===this.parent._position&&(k.y=this.parent.lineCoordinates.y1-k.height+k.fontSize/2+2)}else if("left"===this.parent._position||"right"===this.parent._position){!s(this.parent.dataSeries)&&0<this.parent.dataSeries.length&&(r=this.parent.dataSeries[0].axisX.convertPixelToValue({x:a}));for(w=0;w<this.parent.dataSeries.length;w++)(u=this.parent.dataSeries[w].getDataPointAtX(r,
...
r=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<u&&(u=t,w=r);else t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y)),t<u&&(u=t,w=r);else if("stackedColumn"===n[0].dataSeries.type||"stackedArea"===n[0].dataSeries.type)for(u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=y=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<
n[r].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<u&&(u=t,w=r);else y+=n[r].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(y)),t<u&&(u=t,w=r);else if("stackedColumn100"===n[0].dataSeries.type||"stackedArea100"===n[0].dataSeries.type)for(u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=B=y=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),
t<u&&(u=t,w=r);else y+=n[r].dataPoint.y,B=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,B=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[B]),t=Math.abs(d-this.parent.convertValueToPixel(B)),t<u&&(u=t,w=r);else for(u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<u&&(u=t,w=r);else t=Math.abs(d-
...
Math.abs(d-this.parent.convertValueToPixel(x.dataPoint.y[r])),t<u&&(u=t,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y[b])<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y[b]}):s(this.options.label)?ea(c?c:x.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):this.label;this.value=x.dataPoint.y[b]}else if("stackedColumn"===
this.parent.dataSeries[w].type||"stackedArea"===this.parent.dataSeries[w].type){u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(y)),t<u&&(u=t,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):s(this.options.label)?
ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=y}else if("stackedColumn100"===this.parent.dataSeries[w].type||"stackedArea100"===this.parent.dataSeries[w].type){u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,B=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,B=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[B]),t=Math.abs(d-this.parent.convertValueToPixel(B)),t<u&&(u=t,b=r);m=
...
"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(h);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(m);q.globalAlpha=g};oa(X,U);X.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height=
...
this)}d=[];for(b=0;b<f.length;b++)d.push({xValue:f[b].dataPoint.x,dataPoint:f[b].dataPoint,dataSeries:f[b].dataSeries,dataPointIndex:f[b].index,dataSeriesIndex:f[b].dataSeries._index});n={chart:this.chart,toolTip:this.options,content:n,entries:d};this._entries=f;this.dispatchEvent("updated",n,this)}else this.hide()}};X.prototype.highlightObjects=function(a){var d=this.chart.overlaidCanvasCtx;if(s(this.chart.clearedOverlayedCanvas)||"toolTip"===this.chart.clearedOverlayedCanvas)this.chart.resetOverlayedCanvas(),
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();y.version="v3.4.2 GA";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
